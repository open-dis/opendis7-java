 ...
 */
public class Mode5StatusRecord  implements Serializable{
	...
	private Mode5StatusRecord(Builder builder) {
	...
	private Mode5StatusRecord(short mode5status) {		
		for (int i = 0; i < 16; i++) {
	...
	/**
	 * 
	 * @return Mode5StatusRecord as short
	 */
	...
	public static class Builder {
		...
		public Mode5StatusRecord build() {
			if (this.mode5Status != MODE_5_STATUS_NOT_PRESENT) {
				return new Mode5StatusRecord(this.mode5Status);
			}
			return new Mode5StatusRecord(this);
		}
	}
}
