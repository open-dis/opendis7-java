...
public class FixedAndVariableDatumRoundTripTest {
    ...
    public static void setUpClass() {
        System.out.println(FixedAndVariableDatumRoundTripTest.class.getName() + " setUpClass(), test starting...");
    }

    @AfterAll
    public static void tearDownClass() {
        System.out.println(FixedAndVariableDatumRoundTripTest.class.getName() + " tearDownClass(), test complete");
