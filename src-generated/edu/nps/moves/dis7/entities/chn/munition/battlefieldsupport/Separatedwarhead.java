 ...
 * name: edu.nps.moves.dis7.source.generator.entityTypes.GenerateEntityTypes$SpecificElem@3caee3a8
 * Country: China, Peoples Republic of (CHN)
 * Entity kind: Munition
 * Domain: BATTLEFIELD_SUPPORT
 *
 * Entity type uid: 21552
 */
public class Separatedwarhead extends EntityType
{
    public Separatedwarhead()
    {
        ...
        setSpecific((byte)3); // uid 21552, Separated warhead
    }
}
