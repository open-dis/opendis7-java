...
/**
 * <p> Entity class <b><code>EC135T2i</code></b> collects multiple enumeration values together to uniquely define this entity. </p>
 * <p> <i>Usage:</i> create an instance of this class with <code>EC135T2i.createInstance()</code> or <code>new EC135T2i()</code>. </p>
 * <ul>
 ...
 */
public final class EC135T2i extends EntityType
{
    /** Default constructor */
    public EC135T2i()
    {
    ...
    public static EC135T2i createInstance()
    {
            return new EC135T2i();
    }
}
