 ...
 * name: edu.nps.moves.dis7.source.generator.entityTypes.GenerateEntityTypes$SpecificElem@68746f22;
 * Country: Germany (DEU);
 * Entity kind: Platform;
 * Domain: LAND;
 *
 * Entity type uid: 28109
 */
public class OEMRCPATRIOTAntennaMastGroupAMGonM942chassis extends EntityType
{
    ...
    public OEMRCPATRIOTAntennaMastGroupAMGonM942chassis()
    {
        ...
        setSpecific((byte)5); // uid 28109, OE-MRC PATRIOT Antenna Mast Group (AMG) on M942 chassis
    }
}
