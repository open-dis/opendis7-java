...
/**
 * <p> Entity class <b><code>AstroSPAS</code></b> collects multiple enumeration values together to uniquely define this entity. </p>
 * <p> <i>Usage:</i> create an instance of this class with <code>AstroSPAS.createInstance()</code> or <code>new AstroSPAS()</code>. </p>
 * <ul>
 *     <li> Country: Germany (DEU) = <code>78</code>; </li>
 *     <li> Entity kind: PlatformDomain = <code>SPACE</code>; </li>
 *     <li> Domain: Platform = <code>1</code>; </li>
 *     <li> Category: Satellite - Science/Experimental/Demonstration = <code>14</code>; </li>
 *     <li> SubCategory: AstroSPAS  = <code>5</code>; </li>
 *     <li> Specific: null <code>(none)</code>; </li>
 *     <li> Entity type uid: 38537; </li>
...
public final class AstroSPAS extends EntityType
{
    ...
    public AstroSPAS()
    {
        ...
        setSubCategory((byte)5); // uid 38537, Astro-SPAS
    }
    /** Create a new instance of this final (unmodifiable) class
      * @return copy of class for use as data */
    public static AstroSPAS createInstance()
    {
            return new AstroSPAS();
    }
}
