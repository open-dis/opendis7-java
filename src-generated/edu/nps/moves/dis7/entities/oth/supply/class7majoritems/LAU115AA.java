...
/**
 * <p> Entity class <b><code>LAU115AA</code></b> collects multiple enumeration values together to uniquely define this entity. </p>
 * <p> <i>Usage:</i> create an instance of this class with <code>LAU115AA.createInstance()</code> or <code>new LAU115AA()</code>. </p>
 * <ul>
 ...
 * </ul>
 * <p> Full name: edu.nps.moves.dis7.source.generator.entityTypes.GenerateEntityTypes$ExtraElem@13ddaffb. </p>
 * @see Country#OTHER
 ...
 */
public final class LAU115AA extends EntityType
{
    /** Default constructor */
    public LAU115AA()
    {
    ...
    public static LAU115AA createInstance()
    {
            return new LAU115AA();
    }
}
