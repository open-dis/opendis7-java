 ...
 * name: edu.nps.moves.dis7.source.generator.entityTypes.GenerateEntityTypes$SpecificElem@797f97e3
 * Country: Other
 * Entity kind: Supply
 * Domain: CLASS_9_REPAIR_PARTS_AND_COMPONENTS
 *
 * Entity type uid: 30618
 */
public class ExtinguisherAgentDryPowder extends EntityType
{
    public ExtinguisherAgentDryPowder()
    {
        ...
        setSpecific((byte)2); // uid 30618, Extinguisher Agent - Dry Powder
    }
}
