...
/**
 * <p> Entity class <b><code>S76B</code></b> collects multiple enumeration values together to uniquely define this entity. </p>
 * <p> <i>Usage:</i> create an instance of this class with <code>S76B.createInstance()</code> or <code>new S76B()</code>. </p>
 * <ul>
 ...
 */
public final class S76B extends EntityType
{
    /** Default constructor */
    public S76B()
    {
    ...
    public static S76B createInstance()
    {
            return new S76B();
    }
}
