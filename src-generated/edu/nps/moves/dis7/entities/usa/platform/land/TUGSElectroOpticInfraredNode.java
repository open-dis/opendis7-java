 ...
 * name: edu.nps.moves.dis7.source.generator.entityTypes.GenerateEntityTypes$SpecificElem@59b32539;
 * Country: United States of America (USA);
 * Entity kind: Platform;
 * Domain: LAND;
 *
 * Entity type uid: 22883
 */
public class TUGSElectroOpticInfraredNode extends EntityType
{
    /** Default constructor */
