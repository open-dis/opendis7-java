 ...
 * name: edu.nps.moves.dis7.source.generator.entityTypes.GenerateEntityTypes$SubCategoryElem@7eae55;
 * Country: United States of America (USA);
 * Entity kind: Munition;
 * Domain: DIRECTED_ENERGY_DE_WEAPON;
 *
 * Entity type uid: 20296
 */
public class LaserWeapon extends EntityType
{
    /** Default constructor */
    public LaserWeapon()
    {
