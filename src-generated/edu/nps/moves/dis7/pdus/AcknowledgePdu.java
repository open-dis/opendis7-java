 ...
 * @return deep copy of PDU */
 public AcknowledgePdu copyByteBuffer()
 {
     ...
     {
         System.out.println("AcknowledgePdu deep copy() marshall/unmarshall ByteBuffer exception " + e.getMessage());
         e.printStackTrace();
         System.exit(-1);
     }
     return newCopy;
 ...
 * @return deep copy of PDU */
 public AcknowledgePdu copyDataOutputStream()
 {
     ...
     {
         System.out.println("AcknowledgePdu deep copy() marshall/unmarshall DataOutputStream exception " + e.getMessage());
         e.printStackTrace();
         System.exit(-1);
     }
        try
        ...
        {
            System.out.println("AcknowledgePdu copyDataOutputStream() flush IOException: " + ioe.getMessage());
        }
     return newCopy;
 }
