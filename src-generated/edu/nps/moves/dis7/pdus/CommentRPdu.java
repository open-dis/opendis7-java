 ...
 * @return deep copy of PDU */
 public CommentRPdu copy()
 {
     return copyDataOutputStream();
 }
/** Creates a "deep copy" of current object using ByteBuffer methods.
 * @return deep copy of PDU */
 public CommentRPdu copyByteBuffer()
 {
     ...
     {
         System.out.println("CommentRPdu deep copy() marshall/unmarshall ByteBuffer exception " + e.getMessage());
         e.printStackTrace();
         System.exit(-1);
     }
     return newCopy;
 ...
 * @return deep copy of PDU */
 public CommentRPdu copyDataOutputStream()
 {
     CommentRPdu newCopy = new CommentRPdu();
     try
     {
     ...
     {
         System.out.println("CommentRPdu deep copy() marshall/unmarshall DataOutputStream exception " + e.getMessage());
         e.printStackTrace();
         System.exit(-1);
     }
        try
        ...
        {
            System.out.println("CommentRPdu copyDataOutputStream() flush IOException: " + ioe.getMessage());
        }
     return newCopy;
 }
