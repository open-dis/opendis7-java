...
public class IsPartOfPdu extends EntityManagementFamilyPdu implements Serializable
{
   ...
   public static final String NAME = "IsPartOfPdu";
 ...
 * @return deep copy of PDU */
 public synchronized IsPartOfPdu copyByteBuffer()
 {
     ...
     {
         System.err.println("IsPartOfPdu deep copy() marshall/unmarshall ByteBuffer exception " + e.getMessage());
 ...
 * @return deep copy of PDU */
 public synchronized IsPartOfPdu copyDataOutputStream()
 {
     ...
     {
         System.err.println("IsPartOfPdu deep copy() marshall/unmarshall DataOutputStream exception " + e.getMessage());
         e.printStackTrace(System.err);
         System.exit(-1); // TODO: Abruptly ending VM not a good practice
     }
        try
        ...
        {
            System.err.println("IsPartOfPdu copyDataOutputStream() flush IOException: " + ioe.getMessage());
        }
     return newCopy;
 }
