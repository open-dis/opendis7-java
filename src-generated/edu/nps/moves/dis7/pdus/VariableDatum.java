 ...
 * datum type. Section 6.2.93 IEEE Std 1278.1-2012, IEEE Standard for
...
public class VariableDatum extends Object implements Serializable {
     ...
     * The field format shall depend on the type of datum as specified by the
     * Variable Datum ID. Variable datums can be any number of bits long.
     */
     ...
     * {@link VariableDatum#variableDatumValue} field. Since that field is a
     * byte array, its size must be large enough to contain the specified number
     * of bits. If {@link VariableDatum#variableDatumValue} is NOT set and this
     * pdu is issued (marshaled), the value used when marshaling this field will
     * be the size of the byte array times 8.
     *
     ...
     * {@link VariableDatum#variableDatumValue} field. Since that field is a
     * byte array, its size must be large enough to contain the value specified
     * here. If {@link VariableDatum#variableDatumValue} is NOT set and this pdu
     * is issued (marshaled), the value used when marshaling this field will be
     ...
     * <p>
     * This is described in the specification as a stream of bits, but is
     * implemented in Java as a byte array. The size of the byte array reflects
     * the value of {@link VariableDatum#variableDatumLength} rounded to the
     * next highest byte boundary. If {@link VariableDatum#variableDatumLength}
     * is not set when the Pdu is sent, the receiver will read a bit length
     * equal to the size of the byte array times 8.
     *
    ...
    public int hashCode() {
        int hash = 3;
        hash = 89 * hash + Objects.hashCode(this.variableDatumID);
        hash = 89 * hash + Objects.hashCode(this.variableDatumLength);
        hash = 89 * hash + Arrays.hashCode(this.variableDatumValue);
        hash = 89 * hash + Arrays.hashCode(this.padding);
        return hash;
    }
