 ...
 * @return deep copy of PDU */
 public synchronized ActionResponseRPdu copyByteBuffer()
 {
     ...
     {
         System.out.println("ActionResponseRPdu deep copy() marshall/unmarshall ByteBuffer exception " + e.getMessage());
         e.printStackTrace();
         System.exit(-1);
     }
     return newCopy;
 ...
 * @return deep copy of PDU */
 public synchronized ActionResponseRPdu copyDataOutputStream()
 {
     ...
     {
         System.out.println("ActionResponseRPdu deep copy() marshall/unmarshall DataOutputStream exception " + e.getMessage());
         e.printStackTrace();
         System.exit(-1);
     }
        try
        ...
        {
            System.out.println("ActionResponseRPdu copyDataOutputStream() flush IOException: " + ioe.getMessage());
        }
     return newCopy;
 }
