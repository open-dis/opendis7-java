 ...
 * @return deep copy of PDU */
 public AcknowledgeRPdu copy()
 {
     return copyDataOutputStream();
 }
/** Creates a "deep copy" of current object using ByteBuffer methods.
 * @return deep copy of PDU */
 public AcknowledgeRPdu copyByteBuffer()
 {
     ...
     {
         System.out.println("AcknowledgeRPdu deep copy() marshall/unmarshall ByteBuffer exception " + e.getMessage());
         e.printStackTrace();
         System.exit(-1);
     }
     return newCopy;
 ...
 * @return deep copy of PDU */
 public AcknowledgeRPdu copyDataOutputStream()
 {
     AcknowledgeRPdu newCopy = new AcknowledgeRPdu();
     try
     {
     ...
     {
         System.out.println("AcknowledgeRPdu deep copy() marshall/unmarshall DataOutputStream exception " + e.getMessage());
         e.printStackTrace();
         System.exit(-1);
     }
        try
        ...
        {
            System.out.println("AcknowledgeRPdu copyDataOutputStream() flush IOException: " + ioe.getMessage());
        }
     return newCopy;
 }
