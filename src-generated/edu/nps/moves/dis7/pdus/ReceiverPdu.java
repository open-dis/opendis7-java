 ...
 * @return deep copy of PDU */
 public synchronized ReceiverPdu copyByteBuffer()
 {
     ...
     {
         System.err.println("ReceiverPdu deep copy() marshall/unmarshall ByteBuffer exception " + e.getMessage());
 ...
 * @return deep copy of PDU */
 public synchronized ReceiverPdu copyDataOutputStream()
 {
     ...
     {
         System.err.println("ReceiverPdu deep copy() marshall/unmarshall DataOutputStream exception " + e.getMessage());
         e.printStackTrace(System.err);
         System.exit(-1); // TODO: Abruptly ending VM not a good practice
     }
        try
        ...
        {
            System.err.println("ReceiverPdu copyDataOutputStream() flush IOException: " + ioe.getMessage());
        }
     return newCopy;
 }
