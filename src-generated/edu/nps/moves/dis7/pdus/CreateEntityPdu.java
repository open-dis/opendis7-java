...
public class CreateEntityPdu extends SimulationManagementFamilyPdu implements Serializable
{
   ...
   public static final String NAME = "CreateEntityPdu";
 ...
 * @return deep copy of PDU */
 public synchronized CreateEntityPdu copy()
 {
     return copyDataOutputStream();
 }
/** Creates a "deep copy" of current object using ByteBuffer methods.
 * @return deep copy of PDU */
 public synchronized CreateEntityPdu copyByteBuffer()
 {
     ...
     {
         System.err.println("CreateEntityPdu deep copy() marshall/unmarshall ByteBuffer exception " + e.getMessage());
 ...
 * @return deep copy of PDU */
 public synchronized CreateEntityPdu copyDataOutputStream()
 {
     CreateEntityPdu newCopy = new CreateEntityPdu();
     try
     {
     ...
     {
         System.err.println("CreateEntityPdu deep copy() marshall/unmarshall DataOutputStream exception " + e.getMessage());
         e.printStackTrace(System.err);
         System.exit(-1); // TODO: Abruptly ending VM not a good practice
     }
        try
        ...
        {
            System.err.println("CreateEntityPdu copyDataOutputStream() flush IOException: " + ioe.getMessage());
        }
     return newCopy;
 }
...
public synchronized CreateEntityPdu setRequestID(int pRequestID)
{
