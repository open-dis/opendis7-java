 ...
 * @return deep copy of PDU */
 public synchronized SetDataRPdu copyByteBuffer()
 {
     ...
     {
         System.out.println("SetDataRPdu deep copy() marshall/unmarshall ByteBuffer exception " + e.getMessage());
         e.printStackTrace();
         System.exit(-1);
     }
     return newCopy;
 ...
 * @return deep copy of PDU */
 public synchronized SetDataRPdu copyDataOutputStream()
 {
     ...
     {
         System.out.println("SetDataRPdu deep copy() marshall/unmarshall DataOutputStream exception " + e.getMessage());
         e.printStackTrace();
         System.exit(-1);
     }
        try
        ...
        {
            System.out.println("SetDataRPdu copyDataOutputStream() flush IOException: " + ioe.getMessage());
        }
     return newCopy;
 }
