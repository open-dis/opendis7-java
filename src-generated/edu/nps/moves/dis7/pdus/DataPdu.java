...
public class DataPdu extends SimulationManagementFamilyPdu implements Serializable
{
   ...
   public static final String NAME = "DataPdu";
 ...
 * @return deep copy of PDU */
 public synchronized DataPdu copyByteBuffer()
 {
     ...
     {
         System.err.println("DataPdu deep copy() marshall/unmarshall ByteBuffer exception " + e.getMessage());
 ...
 * @return deep copy of PDU */
 public synchronized DataPdu copyDataOutputStream()
 {
     ...
     {
         System.err.println("DataPdu deep copy() marshall/unmarshall DataOutputStream exception " + e.getMessage());
         e.printStackTrace(System.err);
         System.exit(-1); // TODO: Abruptly ending VM not a good practice
     }
        try
        ...
        {
            System.err.println("DataPdu copyDataOutputStream() flush IOException: " + ioe.getMessage());
        }
     return newCopy;
 }
