 ...
 * @return deep copy of PDU */
 public synchronized RepairResponsePdu copyByteBuffer()
 {
     ...
     {
         System.out.println("RepairResponsePdu deep copy() marshall/unmarshall ByteBuffer exception " + e.getMessage());
         e.printStackTrace();
         System.exit(-1);
     }
     return newCopy;
 ...
 * @return deep copy of PDU */
 public synchronized RepairResponsePdu copyDataOutputStream()
 {
     ...
     {
         System.out.println("RepairResponsePdu deep copy() marshall/unmarshall DataOutputStream exception " + e.getMessage());
         e.printStackTrace();
         System.exit(-1);
     }
        try
        ...
        {
            System.out.println("RepairResponsePdu copyDataOutputStream() flush IOException: " + ioe.getMessage());
        }
     return newCopy;
 }
...
/** Setter for {@link RepairResponsePdu#padding1}
  ...
  * @return same object to permit progressive setters */
public synchronized RepairResponsePdu setPadding1(byte pPadding1)
{
    padding1 = pPadding1;
    return this;
}
...
/** Setter for {@link RepairResponsePdu#padding2}
  ...
  * @return same object to permit progressive setters */
public synchronized RepairResponsePdu setPadding2(short pPadding2)
{
    padding2 = pPadding2;
    return this;
}
