...
public class StartResumeRPdu extends SimulationManagementWithReliabilityFamilyPdu implements Serializable
{
   ...
   public static final String NAME = "StartResumeRPdu";
 ...
 * @return deep copy of PDU */
 public synchronized StartResumeRPdu copyByteBuffer()
 {
     ...
     {
         System.err.println("StartResumeRPdu deep copy() marshall/unmarshall ByteBuffer exception " + e.getMessage());
 ...
 * @return deep copy of PDU */
 public synchronized StartResumeRPdu copyDataOutputStream()
 {
     ...
     {
         System.err.println("StartResumeRPdu deep copy() marshall/unmarshall DataOutputStream exception " + e.getMessage());
         e.printStackTrace(System.err);
         System.exit(-1); // TODO: Abruptly ending VM not a good practice
     }
        try
        ...
        {
            System.err.println("StartResumeRPdu copyDataOutputStream() flush IOException: " + ioe.getMessage());
        }
     return newCopy;
 }
