 ...
 */
public class SignalPduSpecialCase extends RadioCommunicationsFamilyPdu implements Serializable
{
  ...
  /**
   * Setter for {@link SignalPduSpecialCase#header}
  ...
  /**
   * Getter for {@link SignalPduSpecialCase#header}
   * @return header
   */
  ...
  /**
   * Setter for {@link SignalPduSpecialCase#encodingScheme}
  ...
  /**
   * Getter for {@link SignalPduSpecialCase#encodingScheme}
  ...
  /**
   * Setter for {@link SignalPduSpecialCase#tdlType}
   *
  ...
  /**
   * Getter for {@link SignalPduSpecialCase#tdlType}
  ...
  /**
   * Setter for {@link SignalPduSpecialCase#sampleRate}
   *
  ...
  /**
   * Getter for {@link SignalPduSpecialCase#sampleRate}
   * @return sampleRate
   */
  ...
  /**
   * Setter for {@link SignalPduSpecialCase#dataLength}
   * <p>
   * This value is the size IN BITS of the {@link SignalPduSpecialCase#dataLength} field. Since that field
  ...
  /**
   * Getter for {@link SignalPduSpecialCase#dataLength}
   *
  ...
  /**
   * Setter for {@link SignalPduSpecialCase#samples}
   *
  ...
  /**
   * Getter for {@link SignalPduSpecialCase#samples}
   *
   * @return value of field
   */
  ...
  /**
   * Setter for {@link SignalPduSpecialCase#data}
   * <p>
   * This is described in the specification as a stream of bits, but is implemented in Java as a byte array.
   * The size of the byte array reflects the value of {@link SignalPduSpecialCase#dataLength} rounded to the next
   * highest byte boundary. If {@link SignalPduSpecialCase#dataLength} is not set when the Pdu is sent, the
  ...
  /**
   * Getter for {@link SignalPduSpecialCase#data}
   *
   * @return value of field
   */
  public byte[] getData()
  ...
  * The equals method doesn't always work--mostly it works only on classes that consist only of primitives. Be careful.
  ...
  public boolean equalsImpl(Object obj)
  {
    ...
    if (!(obj instanceof SignalPduSpecialCase))
      return false;

    final SignalPduSpecialCase rhs = (SignalPduSpecialCase) obj;
