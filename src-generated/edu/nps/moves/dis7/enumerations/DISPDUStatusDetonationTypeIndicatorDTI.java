...
public enum DISPDUStatusDetonationTypeIndicatorDTI 
{
     ...
     */
    public static DISPDUStatusDetonationTypeIndicatorDTI getEnumForValue(int value)
    {
       for (DISPDUStatusDetonationTypeIndicatorDTI nextEnum : DISPDUStatusDetonationTypeIndicatorDTI.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum DISPDUStatusDetonationTypeIndicatorDTI");
