...
public enum DISPDUStatusDetonationTypeIndicatorDTI 
{
    ...
    public static DISPDUStatusDetonationTypeIndicatorDTI unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "DISPDUStatusDetonationTypeIndicatorDTI " + getValue() + " " + name(); 
    }
}
