 ...
 *  UID 349,
 * marshal size 8;
 * ISLSAntennaType has 2 enumerations total.
...
public enum ISLSAntennaType 
{
     ...
     */
    public static ISLSAntennaType getEnumForValue(int value)
    {
       for (ISLSAntennaType nextEnum : ISLSAntennaType.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum ISLSAntennaType");
