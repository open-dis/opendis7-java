 ...
 *  UID 176,
 * marshal size 8;
 * MessageTypeIdentifier has 8 enumerations total.
...
public enum MessageTypeIdentifier 
{
     ...
     */
    public static MessageTypeIdentifier getEnumForValue(int value)
    {
       for (MessageTypeIdentifier nextEnum : MessageTypeIdentifier.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum MessageTypeIdentifier");
