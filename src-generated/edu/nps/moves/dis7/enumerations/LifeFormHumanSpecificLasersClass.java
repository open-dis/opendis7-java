 ...
 *  UID 527,
 * marshal size 8;
 * LifeFormHumanSpecificLasersClass has 2 enumerations total.
...
public enum LifeFormHumanSpecificLasersClass 
{
     ...
     */
    public static LifeFormHumanSpecificLasersClass getEnumForValue(int value)
    {
       for (LifeFormHumanSpecificLasersClass nextEnum : LifeFormHumanSpecificLasersClass.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum LifeFormHumanSpecificLasersClass");
