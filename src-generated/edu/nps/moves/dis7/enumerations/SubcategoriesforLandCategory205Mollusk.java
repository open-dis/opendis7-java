...
public enum SubcategoriesforLandCategory205Mollusk implements SubCategory
{
    ...
    public static SubcategoriesforLandCategory205Mollusk unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "SubcategoriesforLandCategory205Mollusk " + getValue() + " " + name(); 
    }
}
