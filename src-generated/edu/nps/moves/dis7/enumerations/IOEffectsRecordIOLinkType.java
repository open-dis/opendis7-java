 ...
 *  UID 291,
 * marshal size 8;
 * IOEffectsRecordIOLinkType has 4 enumerations total.
...
public enum IOEffectsRecordIOLinkType 
{
     ...
     */
    public static IOEffectsRecordIOLinkType getEnumForValue(int value)
    {
       for (IOEffectsRecordIOLinkType nextEnum : IOEffectsRecordIOLinkType.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum IOEffectsRecordIOLinkType");
