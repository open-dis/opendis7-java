 ...
 * PlatformAirCivilianUltralightRigidWingAircraftSubcategories has 2 enumerations total.
...
public enum PlatformAirCivilianUltralightRigidWingAircraftSubcategories implements SubCategory
{
     ...
     */
    public static PlatformAirCivilianUltralightRigidWingAircraftSubcategories getEnumForValue(int value)
    {
       for (PlatformAirCivilianUltralightRigidWingAircraftSubcategories nextEnum : PlatformAirCivilianUltralightRigidWingAircraftSubcategories.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum PlatformAirCivilianUltralightRigidWingAircraftSubcategories");
