 ...
 *  UID 143,
 * marshal size 8;
 * UAStateChangeUpdateIndicator has 2 enumerations total.
...
public enum UAStateChangeUpdateIndicator 
{
     ...
     */
    public static UAStateChangeUpdateIndicator getEnumForValue(int value)
    {
       for (UAStateChangeUpdateIndicator nextEnum : UAStateChangeUpdateIndicator.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum UAStateChangeUpdateIndicator");
