 ...
 *  UID 357,
 * marshal size 8;
 * AircraftIdentificationType has 3 enumerations total.
...
public enum AircraftIdentificationType 
{
     ...
     */
    public static AircraftIdentificationType getEnumForValue(int value)
    {
       for (AircraftIdentificationType nextEnum : AircraftIdentificationType.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum AircraftIdentificationType");
