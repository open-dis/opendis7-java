 ...
 *  UID 209,
 * marshal size 8;
 * AggregateStateSpecific has 2 enumerations total.
...
public enum AggregateStateSpecific 
{
     ...
     */
    public static AggregateStateSpecific getEnumForValue(int value)
    {
       for (AggregateStateSpecific nextEnum : AggregateStateSpecific.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum AggregateStateSpecific");
