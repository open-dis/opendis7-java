 ...
 *  UID 522,
 * marshal size 8;
 * LifeFormHumanSpecificFlameRockets has 7 enumerations total.
...
public enum LifeFormHumanSpecificFlameRockets 
{
     ...
     */
    public static LifeFormHumanSpecificFlameRockets getEnumForValue(int value)
    {
       for (LifeFormHumanSpecificFlameRockets nextEnum : LifeFormHumanSpecificFlameRockets.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum LifeFormHumanSpecificFlameRockets");
