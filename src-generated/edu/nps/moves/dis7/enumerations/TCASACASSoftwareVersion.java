 ...
 *  UID 343,
 * marshal size 3;
 * TCASACASSoftwareVersion has 3 enumerations total.
...
public enum TCASACASSoftwareVersion 
{
     ...
     */
    public static TCASACASSoftwareVersion getEnumForValue(int value)
    {
       for (TCASACASSoftwareVersion nextEnum : TCASACASSoftwareVersion.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum TCASACASSoftwareVersion");
