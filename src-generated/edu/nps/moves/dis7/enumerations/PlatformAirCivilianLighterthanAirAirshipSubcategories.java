...
public enum PlatformAirCivilianLighterthanAirAirshipSubcategories implements SubCategory
{
    ...
    public static PlatformAirCivilianLighterthanAirAirshipSubcategories unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "PlatformAirCivilianLighterthanAirAirshipSubcategories " + getValue() + " " + name(); 
    }
}
