 ...
 * PlatformAirCivilianLighterthanAirAirshipSubcategories has 4 enumerations total.
...
public enum PlatformAirCivilianLighterthanAirAirshipSubcategories implements SubCategory
{
     ...
     */
    public static PlatformAirCivilianLighterthanAirAirshipSubcategories getEnumForValue(int value)
    {
       for (PlatformAirCivilianLighterthanAirAirshipSubcategories nextEnum : PlatformAirCivilianLighterthanAirAirshipSubcategories.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum PlatformAirCivilianLighterthanAirAirshipSubcategories");
