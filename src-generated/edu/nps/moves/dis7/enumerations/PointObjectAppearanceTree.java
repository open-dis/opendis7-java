...
public class PointObjectAppearanceTree extends DisBitSet 
{
  ...
  public PointObjectAppearanceTree(Bits wh, int value)
  {
    this();
    set(wh,value);
  }
   ...
   * @param value bits of interest
   * @return this object */
  public PointObjectAppearanceTree set(Bits wh, int value)
  {
...
*/
   ...
   * @param value bits of interest
   * @return this object */
  public PointObjectAppearanceTree set(int start, int length, int value)
  {
