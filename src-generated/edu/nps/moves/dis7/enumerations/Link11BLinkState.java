 ...
 *  UID 737,
 * marshal size 8;
 * Link11BLinkState has 5 enumerations total.
...
public enum Link11BLinkState 
{
     ...
     */
    public static Link11BLinkState getEnumForValue(int value)
    {
       for (Link11BLinkState nextEnum : Link11BLinkState.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Link11BLinkState");
