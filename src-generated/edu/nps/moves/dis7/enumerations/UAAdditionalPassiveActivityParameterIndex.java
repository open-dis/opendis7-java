 ...
 *  UID 150,
 * marshal size 16;
 * UAAdditionalPassiveActivityParameterIndex has 1 enumerations total.
...
public enum UAAdditionalPassiveActivityParameterIndex 
{
     ...
     */
    public static UAAdditionalPassiveActivityParameterIndex getEnumForValue(int value)
    {
       for (UAAdditionalPassiveActivityParameterIndex nextEnum : UAAdditionalPassiveActivityParameterIndex.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum UAAdditionalPassiveActivityParameterIndex");
