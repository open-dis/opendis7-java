 ...
 *  UID 374,
 * marshal size 1;
 * DEFireFlagsStateUpdateFlag has 2 enumerations total.
...
public enum DEFireFlagsStateUpdateFlag 
{
     ...
     */
    public static DEFireFlagsStateUpdateFlag getEnumForValue(int value)
    {
       for (DEFireFlagsStateUpdateFlag nextEnum : DEFireFlagsStateUpdateFlag.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum DEFireFlagsStateUpdateFlag");
