 ...
 *  UID 740,
 * marshal size 8;
 * Link11BDataSignalingRate has 6 enumerations total.
...
public enum Link11BDataSignalingRate 
{
     ...
     */
    public static Link11BDataSignalingRate getEnumForValue(int value)
    {
       for (Link11BDataSignalingRate nextEnum : Link11BDataSignalingRate.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Link11BDataSignalingRate");
