 ...
 *  UID 734,
 * marshal size 8;
 * Link11SignalWaveform has 3 enumerations total.
...
public enum Link11SignalWaveform 
{
     ...
     */
    public static Link11SignalWaveform getEnumForValue(int value)
    {
       for (Link11SignalWaveform nextEnum : Link11SignalWaveform.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Link11SignalWaveform");
