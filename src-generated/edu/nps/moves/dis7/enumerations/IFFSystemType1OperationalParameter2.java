 ...
 *  UID 98,
 * marshal size 8;
 * IFFSystemType1OperationalParameter2 has 1 enumerations total.
...
public enum IFFSystemType1OperationalParameter2 
{
     ...
     */
    public static IFFSystemType1OperationalParameter2 getEnumForValue(int value)
    {
       for (IFFSystemType1OperationalParameter2 nextEnum : IFFSystemType1OperationalParameter2.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum IFFSystemType1OperationalParameter2");
