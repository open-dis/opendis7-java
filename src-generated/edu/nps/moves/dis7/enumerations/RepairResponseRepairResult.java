 ...
 *  UID 65,
 * marshal size 8;
 * RepairResponseRepairResult has 5 enumerations total.
...
public enum RepairResponseRepairResult 
{
     ...
     */
    public static RepairResponseRepairResult getEnumForValue(int value)
    {
       for (RepairResponseRepairResult nextEnum : RepairResponseRepairResult.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum RepairResponseRepairResult");
