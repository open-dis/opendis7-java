 ...
 *  UID 361,
 * marshal size 1;
 * Mode5SAltitudeResolution has 2 enumerations total.
...
public enum Mode5SAltitudeResolution 
{
     ...
     */
    public static Mode5SAltitudeResolution getEnumForValue(int value)
    {
       for (Mode5SAltitudeResolution nextEnum : Mode5SAltitudeResolution.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Mode5SAltitudeResolution");
