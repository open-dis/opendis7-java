 ...
 *  UID 380,
 * marshal size 1;
 * Mode5MessageFormatsStatus has 2 enumerations total.
...
public enum Mode5MessageFormatsStatus 
{
     ...
     */
    public static Mode5MessageFormatsStatus getEnumForValue(int value)
    {
       for (Mode5MessageFormatsStatus nextEnum : Mode5MessageFormatsStatus.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Mode5MessageFormatsStatus");
