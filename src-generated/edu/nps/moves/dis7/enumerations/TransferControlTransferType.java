...
public enum TransferControlTransferType 
{
     ...
     */
    public static TransferControlTransferType getEnumForValue(int value)
    {
       for (TransferControlTransferType nextEnum : TransferControlTransferType.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum TransferControlTransferType");
