 ...
 *  UID 197,
 * marshal size 12;
 * MinefieldSensorTypesMagnetic has 4 enumerations total.
...
public enum MinefieldSensorTypesMagnetic 
{
     ...
     */
    public static MinefieldSensorTypesMagnetic getEnumForValue(int value)
    {
       for (MinefieldSensorTypesMagnetic nextEnum : MinefieldSensorTypesMagnetic.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum MinefieldSensorTypesMagnetic");
