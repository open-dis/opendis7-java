 ...
 * PlatformLandFarmSpecialtyVehicleSubcategories has 9 enumerations total.
...
public enum PlatformLandFarmSpecialtyVehicleSubcategories implements SubCategory
{
     ...
     */
    public static PlatformLandFarmSpecialtyVehicleSubcategories getEnumForValue(int value)
    {
       for (PlatformLandFarmSpecialtyVehicleSubcategories nextEnum : PlatformLandFarmSpecialtyVehicleSubcategories.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum PlatformLandFarmSpecialtyVehicleSubcategories");
