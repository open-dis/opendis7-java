...
public enum PlatformLandFarmSpecialtyVehicleSubcategories implements SubCategory
{
    ...
    public static PlatformLandFarmSpecialtyVehicleSubcategories unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "PlatformLandFarmSpecialtyVehicleSubcategories " + getValue() + " " + name(); 
    }
}
