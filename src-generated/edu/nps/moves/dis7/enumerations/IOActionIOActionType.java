 ...
 *  UID 287,
 * marshal size 16;
 * IOActionIOActionType has 5 enumerations total.
...
public enum IOActionIOActionType 
{
    ...
    /** Intent-Based-EW - Computed Effects */
    // autogenerated using string template disenumpart2.txt
     ...
     */
    public static IOActionIOActionType getEnumForValue(int value)
    {
       for (IOActionIOActionType nextEnum : IOActionIOActionType.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum IOActionIOActionType");
