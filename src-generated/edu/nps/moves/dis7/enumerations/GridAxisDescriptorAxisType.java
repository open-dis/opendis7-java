 ...
 *  UID 377,
 * marshal size 8;
 * GridAxisDescriptorAxisType has 2 enumerations total.
...
public enum GridAxisDescriptorAxisType 
{
     ...
     */
    public static GridAxisDescriptorAxisType getEnumForValue(int value)
    {
       for (GridAxisDescriptorAxisType nextEnum : GridAxisDescriptorAxisType.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum GridAxisDescriptorAxisType");
