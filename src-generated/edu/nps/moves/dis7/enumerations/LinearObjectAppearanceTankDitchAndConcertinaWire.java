...
public class LinearObjectAppearanceTankDitchAndConcertinaWire extends DisBitSet 
{
  ...
  /**
   * (bit position 16, length=8) 8-bit unsigned integer indicating the fixed length in meters of a breached segment
   */
  ...
  // autogenerated using string template disbitsetcomment.txt
  /**
   * (bit position 24, length=8) 8-bit record where each bit indicates whether its associated segment is breached or not, such that bit 0 of the record is the first segment
   */
  // autogenerated using string template disbitset15.txt
