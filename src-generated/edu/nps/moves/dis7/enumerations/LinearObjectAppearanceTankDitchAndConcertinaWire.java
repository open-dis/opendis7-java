...
public class LinearObjectAppearanceTankDitchAndConcertinaWire extends DisBitSet 
{
  ...
  public LinearObjectAppearanceTankDitchAndConcertinaWire(Bits wh, int value)
  {
    this();
    set(wh,value);
  }
   ...
   * @param value bits of interest
   * @return this object */
  public LinearObjectAppearanceTankDitchAndConcertinaWire set(Bits wh, int value)
  {
...
*/
   ...
   * @param value bits of interest
   * @return this object */
  public LinearObjectAppearanceTankDitchAndConcertinaWire set(int start, int length, int value)
  {
