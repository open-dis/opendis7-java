...
public enum PlatformAirCivilianUltralightNonrigidWingAircraftSubcategories implements SubCategory
{
    ...
    public static PlatformAirCivilianUltralightNonrigidWingAircraftSubcategories unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "PlatformAirCivilianUltralightNonrigidWingAircraftSubcategories " + getValue() + " " + name(); 
    }
}
