 ...
 *  UID 165,
 * marshal size 8;
 * TransmitterInputSource has 19 enumerations total.
...
public enum TransmitterInputSource 
{
    ...
    /** Crew Observer 1 */
    // autogenerated using string template disenumpart2.txt
    CREW_OBSERVER_1 (15, "Crew Observer 1"),
    // autogenerated using string template disenumfootnotecomment.txt

    /** Crew Observer 2 */
    // autogenerated using string template disenumpart2.txt
    CREW_OBSERVER_2 (16, "Crew Observer 2"),
    // autogenerated using string template disenumfootnotecomment.txt

    /** Aerial Refueling Officer (ARO) */
    // autogenerated using string template disenumpart2.txt
    AERIAL_REFUELING_OFFICER_ARO (17, "Aerial Refueling Officer (ARO)"),
    // autogenerated using string template disenumfootnotecomment.txt

    /** Aerial Refueling Officer Instructor (AROI) */
    // autogenerated using string template disenumpart2.txt
    AERIAL_REFUELING_OFFICER_INSTRUCTOR_AROI (18, "Aerial Refueling Officer Instructor (AROI)");
