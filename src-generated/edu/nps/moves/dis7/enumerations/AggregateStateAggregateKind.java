 ...
 *  UID 206,
 * marshal size 8;
 * AggregateStateAggregateKind has 6 enumerations total.
...
public enum AggregateStateAggregateKind 
{
     ...
     */
    public static AggregateStateAggregateKind getEnumForValue(int value)
    {
       for (AggregateStateAggregateKind nextEnum : AggregateStateAggregateKind.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum AggregateStateAggregateKind");
