 ...
 *  UID 345,
 * marshal size 1;
 * TCASIIIType has 2 enumerations total.
...
public enum TCASIIIType 
{
     ...
     */
    public static TCASIIIType getEnumForValue(int value)
    {
       for (TCASIIIType nextEnum : TCASIIIType.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum TCASIIIType");
