 ...
 *  UID 386,
 * marshal size 1;
 * AppearanceEntityorObjectState has 2 enumerations total.
...
public enum AppearanceEntityorObjectState 
{
     ...
     */
    public static AppearanceEntityorObjectState getEnumForValue(int value)
    {
       for (AppearanceEntityorObjectState nextEnum : AppearanceEntityorObjectState.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum AppearanceEntityorObjectState");
