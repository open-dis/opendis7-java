 ...
 *  UID 170,
 * marshal size 8;
 * CCTTSINCGARSStartofMessage has 2 enumerations total.
...
public enum CCTTSINCGARSStartofMessage 
{
     ...
     */
    public static CCTTSINCGARSStartofMessage getEnumForValue(int value)
    {
       for (CCTTSINCGARSStartofMessage nextEnum : CCTTSINCGARSStartofMessage.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum CCTTSINCGARSStartofMessage");
