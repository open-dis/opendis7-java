...
public enum Mode5Reply 
{
     ...
     */
    public static Mode5Reply getEnumForValue(int value)
    {
       for (Mode5Reply nextEnum : Mode5Reply.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Mode5Reply");
