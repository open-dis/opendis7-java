 ...
 * PlatformSubsurfaceCivilianSemiSubmersiblesSubcategories has 1 enumerations total.
...
public enum PlatformSubsurfaceCivilianSemiSubmersiblesSubcategories implements SubCategory
{
     ...
     */
    public static PlatformSubsurfaceCivilianSemiSubmersiblesSubcategories getEnumForValue(int value)
    {
       for (PlatformSubsurfaceCivilianSemiSubmersiblesSubcategories nextEnum : PlatformSubsurfaceCivilianSemiSubmersiblesSubcategories.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum PlatformSubsurfaceCivilianSemiSubmersiblesSubcategories");
