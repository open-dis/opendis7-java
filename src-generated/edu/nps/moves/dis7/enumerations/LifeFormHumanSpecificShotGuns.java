...
public enum LifeFormHumanSpecificShotGuns 
{
    ...
    // autogenerated using string template disenumpart2.txt
    DESIGNATOR (24, "16.8mm Browning Citori O/U 16 Gauge"),
    // autogenerated using string template disenumfootnotecomment.txt
    ...
    // autogenerated using string template disenumpart2.txt
    UNDERWATER_ACOUSTIC (29, "18.5mm Ithaca 37 12 Gauge"),
    // autogenerated using string template disenumfootnotecomment.txt
     ...
     */
    public static LifeFormHumanSpecificShotGuns getEnumForValue(int value)
    {
       for (LifeFormHumanSpecificShotGuns nextEnum : LifeFormHumanSpecificShotGuns.values())
       {
