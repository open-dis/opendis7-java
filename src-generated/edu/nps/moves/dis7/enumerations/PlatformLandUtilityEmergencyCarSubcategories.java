...
public enum PlatformLandUtilityEmergencyCarSubcategories implements SubCategory
{
    ...
    public static PlatformLandUtilityEmergencyCarSubcategories unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "PlatformLandUtilityEmergencyCarSubcategories " + getValue() + " " + name(); 
    }
}
