 ...
 *  UID 395,
 * marshal size 4;
 * AppearanceEnvironmentalDensity has 5 enumerations total.
...
public enum AppearanceEnvironmentalDensity 
{
     ...
     */
    public static AppearanceEnvironmentalDensity getEnumForValue(int value)
    {
       for (AppearanceEnvironmentalDensity nextEnum : AppearanceEnvironmentalDensity.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum AppearanceEnvironmentalDensity");
