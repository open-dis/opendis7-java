 ...
 *  UID 172,
 * marshal size 8;
 * TimeSlotAllocationLevel has 5 enumerations total.
...
public enum TimeSlotAllocationLevel 
{
     ...
     */
    public static TimeSlotAllocationLevel getEnumForValue(int value)
    {
       for (TimeSlotAllocationLevel nextEnum : TimeSlotAllocationLevel.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum TimeSlotAllocationLevel");
