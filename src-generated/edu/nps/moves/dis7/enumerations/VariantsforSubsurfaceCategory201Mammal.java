...
public enum VariantsforSubsurfaceCategory201Mammal 
{
    ...
    public static VariantsforSubsurfaceCategory201Mammal unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "VariantsforSubsurfaceCategory201Mammal " + getValue() + " " + name(); 
    }
}
