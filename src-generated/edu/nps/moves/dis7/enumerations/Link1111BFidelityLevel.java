 ...
 *  UID 467,
 * marshal size 8;
 * Link1111BFidelityLevel has 3 enumerations total.
...
public enum Link1111BFidelityLevel 
{
     ...
     */
    public static Link1111BFidelityLevel getEnumForValue(int value)
    {
       for (Link1111BFidelityLevel nextEnum : Link1111BFidelityLevel.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Link1111BFidelityLevel");
