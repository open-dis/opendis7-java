 ...
 *  UID 273,
 * marshal size 8;
 * EnvironmentRecordTypeGroups has 2 enumerations total.
...
public enum EnvironmentRecordTypeGroups 
{
     ...
     */
    public static EnvironmentRecordTypeGroups getEnumForValue(int value)
    {
       for (EnvironmentRecordTypeGroups nextEnum : EnvironmentRecordTypeGroups.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum EnvironmentRecordTypeGroups");
