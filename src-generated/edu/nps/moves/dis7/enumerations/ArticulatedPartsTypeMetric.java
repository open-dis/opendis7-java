 ...
 *  UID 58,
 * marshal size 5;
 * ArticulatedPartsTypeMetric has 17 enumerations total.
...
public enum ArticulatedPartsTypeMetric 
{
     ...
     */
    public static ArticulatedPartsTypeMetric getEnumForValue(int value)
    {
       for (ArticulatedPartsTypeMetric nextEnum : ArticulatedPartsTypeMetric.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum ArticulatedPartsTypeMetric");
