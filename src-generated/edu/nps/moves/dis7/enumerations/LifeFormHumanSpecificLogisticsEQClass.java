 ...
 *  UID 525,
 * marshal size 8;
 * LifeFormHumanSpecificLogisticsEQClass has 1 enumerations total.
...
public enum LifeFormHumanSpecificLogisticsEQClass 
{
     ...
     */
    public static LifeFormHumanSpecificLogisticsEQClass getEnumForValue(int value)
    {
       for (LifeFormHumanSpecificLogisticsEQClass nextEnum : LifeFormHumanSpecificLogisticsEQClass.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum LifeFormHumanSpecificLogisticsEQClass");
