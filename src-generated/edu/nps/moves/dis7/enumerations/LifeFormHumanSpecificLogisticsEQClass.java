...
public enum LifeFormHumanSpecificLogisticsEQClass 
{
    ...
    public static LifeFormHumanSpecificLogisticsEQClass unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "LifeFormHumanSpecificLogisticsEQClass " + getValue() + " " + name(); 
    }
}
