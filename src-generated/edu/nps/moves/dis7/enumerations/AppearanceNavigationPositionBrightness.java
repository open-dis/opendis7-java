 ...
 *  UID 398,
 * marshal size 1;
 * AppearanceNavigationPositionBrightness has 2 enumerations total.
...
public enum AppearanceNavigationPositionBrightness 
{
     ...
     */
    public static AppearanceNavigationPositionBrightness getEnumForValue(int value)
    {
       for (AppearanceNavigationPositionBrightness nextEnum : AppearanceNavigationPositionBrightness.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum AppearanceNavigationPositionBrightness");
