 ...
 *  UID 342,
 * marshal size 1;
 * TCASACASIndicator has 2 enumerations total.
...
public enum TCASACASIndicator 
{
     ...
     */
    public static TCASACASIndicator getEnumForValue(int value)
    {
       for (TCASACASIndicator nextEnum : TCASACASIndicator.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum TCASACASIndicator");
