 ...
 *  UID 174,
 * marshal size 8;
 * JTIDSMIDSModulationParametersTransmittingTerminalSecondaryMode has 4 enumerations total.
...
public enum JTIDSMIDSModulationParametersTransmittingTerminalSecondaryMode 
{
     ...
     */
    public static JTIDSMIDSModulationParametersTransmittingTerminalSecondaryMode getEnumForValue(int value)
    {
       for (JTIDSMIDSModulationParametersTransmittingTerminalSecondaryMode nextEnum : JTIDSMIDSModulationParametersTransmittingTerminalSecondaryMode.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum JTIDSMIDSModulationParametersTransmittingTerminalSecondaryMode");
