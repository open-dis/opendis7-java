 ...
 *  UID 79,
 * marshal size 8;
 * HighDensityTrackJam has 2 enumerations total.
...
public enum HighDensityTrackJam 
{
     ...
     */
    public static HighDensityTrackJam getEnumForValue(int value)
    {
       for (HighDensityTrackJam nextEnum : HighDensityTrackJam.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum HighDensityTrackJam");
