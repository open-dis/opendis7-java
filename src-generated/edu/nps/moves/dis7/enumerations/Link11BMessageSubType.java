 ...
 *  UID 739,
 * marshal size 8;
 * Link11BMessageSubType has 3 enumerations total.
...
public enum Link11BMessageSubType 
{
     ...
     */
    public static Link11BMessageSubType getEnumForValue(int value)
    {
       for (Link11BMessageSubType nextEnum : Link11BMessageSubType.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Link11BMessageSubType");
