 ...
 *  UID 394,
 * marshal size 1;
 * AppearanceConcealedMovement has 2 enumerations total.
...
public enum AppearanceConcealedMovement 
{
     ...
     */
    public static AppearanceConcealedMovement getEnumForValue(int value)
    {
       for (AppearanceConcealedMovement nextEnum : AppearanceConcealedMovement.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum AppearanceConcealedMovement");
