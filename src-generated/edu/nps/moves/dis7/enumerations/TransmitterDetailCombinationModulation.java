 ...
 *  UID 159,
 * marshal size 16;
 * TransmitterDetailCombinationModulation has 2 enumerations total.
...
public enum TransmitterDetailCombinationModulation 
{
     ...
     */
    public static TransmitterDetailCombinationModulation getEnumForValue(int value)
    {
       for (TransmitterDetailCombinationModulation nextEnum : TransmitterDetailCombinationModulation.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum TransmitterDetailCombinationModulation");
