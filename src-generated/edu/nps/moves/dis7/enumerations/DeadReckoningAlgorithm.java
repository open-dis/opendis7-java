 ...
 *  UID 44,
 * marshal size 8;
 * DeadReckoningAlgorithm has 11 enumerations total.
...
public enum DeadReckoningAlgorithm 
{
    ...
    /** Combined Parabolic/Circular (CPC), Applicable to DIS 8 and later only. */
    // autogenerated using string template disenumpart2.txt
    COMBINED_PARABOLIC_CIRCULAR_CPC (10, "Combined Parabolic/Circular (CPC)");
     ...
     */
    public static DeadReckoningAlgorithm getEnumForValue(int value)
    {
       for (DeadReckoningAlgorithm nextEnum : DeadReckoningAlgorithm.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum DeadReckoningAlgorithm");
