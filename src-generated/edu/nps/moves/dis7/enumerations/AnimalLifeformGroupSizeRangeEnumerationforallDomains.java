...
public enum AnimalLifeformGroupSizeRangeEnumerationforallDomains 
{
     ...
     */
    public static AnimalLifeformGroupSizeRangeEnumerationforallDomains getEnumForValue(int value)
    {
       for (AnimalLifeformGroupSizeRangeEnumerationforallDomains nextEnum : AnimalLifeformGroupSizeRangeEnumerationforallDomains.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum AnimalLifeformGroupSizeRangeEnumerationforallDomains");
