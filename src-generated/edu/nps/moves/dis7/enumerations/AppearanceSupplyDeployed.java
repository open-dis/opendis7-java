 ...
 *  UID 399,
 * marshal size 2;
 * AppearanceSupplyDeployed has 4 enumerations total.
...
public enum AppearanceSupplyDeployed 
{
     ...
     */
    public static AppearanceSupplyDeployed getEnumForValue(int value)
    {
       for (AppearanceSupplyDeployed nextEnum : AppearanceSupplyDeployed.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum AppearanceSupplyDeployed");
