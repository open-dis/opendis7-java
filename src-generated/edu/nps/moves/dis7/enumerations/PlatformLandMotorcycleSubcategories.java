 ...
 * PlatformLandMotorcycleSubcategories has 5 enumerations total.
...
public enum PlatformLandMotorcycleSubcategories implements SubCategory
{
     ...
     */
    public static PlatformLandMotorcycleSubcategories getEnumForValue(int value)
    {
       for (PlatformLandMotorcycleSubcategories nextEnum : PlatformLandMotorcycleSubcategories.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum PlatformLandMotorcycleSubcategories");
