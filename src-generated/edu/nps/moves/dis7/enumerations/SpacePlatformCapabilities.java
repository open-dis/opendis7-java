...
public class SpacePlatformCapabilities extends DisBitSet implements EntityCapabilities
{
  ...
  public SpacePlatformCapabilities(Bits wh, int i)
  {
    this();
    set(wh,i);
  }

  public SpacePlatformCapabilities set(Bits wh, int val)
  {
...
*/
  ...
  public SpacePlatformCapabilities set(int start, int length, int val)
  {
