...
public class SurfacePlatformCapabilities extends DisBitSet implements EntityCapabilities
{
  ...
  public SurfacePlatformCapabilities()
  {
    super(32); // length from bitfield element
  }

  public SurfacePlatformCapabilities(Bits wh, int i)
  {
    this();
    set(wh,i);
  }

  public SurfacePlatformCapabilities set(Bits wh, int val)
  {
...
/*
  public SurfacePlatformCapabilities set(Bits wh, Object val) throws Exception
  {
...
*/
  ...
  public SurfacePlatformCapabilities set(int start, int length, int val)
  {
