...
public class SurfacePlatformCapabilities extends DisBitSet implements EntityCapabilities
{
  ...
  public SurfacePlatformCapabilities(Bits wh, int value)
  {
    this();
    set(wh,value);
  }
   ...
   * @param value bits of interest
   * @return this object */
  public SurfacePlatformCapabilities set(Bits wh, int value)
  {
...
*/
   ...
   * @param value bits of interest
   * @return this object */
  public SurfacePlatformCapabilities set(int start, int length, int value)
  {
