 ...
 *  UID 612,
 * marshal size 8;
 * Class12SupplyCategorySlingLoadsNonDoctrinal has 13 enumerations total.
...
public enum Class12SupplyCategorySlingLoadsNonDoctrinal implements Category
{
    ...
    /** Sling Load, Trailers */
    // autogenerated using string template disenumpart2.txt
    SLING_LOAD_TRAILERS (13, "Sling Load, Trailers");
     ...
     */
    public static Class12SupplyCategorySlingLoadsNonDoctrinal getEnumForValue(int value)
    {
       for (Class12SupplyCategorySlingLoadsNonDoctrinal nextEnum : Class12SupplyCategorySlingLoadsNonDoctrinal.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Class12SupplyCategorySlingLoadsNonDoctrinal");
