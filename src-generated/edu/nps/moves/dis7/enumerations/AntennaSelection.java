 ...
 *  UID 351,
 * marshal size 2;
 * AntennaSelection has 4 enumerations total.
...
public enum AntennaSelection 
{
     ...
     */
    public static AntennaSelection getEnumForValue(int value)
    {
       for (AntennaSelection nextEnum : AntennaSelection.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum AntennaSelection");
