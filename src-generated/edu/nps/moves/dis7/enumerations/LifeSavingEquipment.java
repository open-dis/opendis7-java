 ...
 * LifeSavingEquipment has 4 enumerations total.
...
public enum LifeSavingEquipment implements SubCategory
{
     ...
     */
    public static LifeSavingEquipment getEnumForValue(int value)
    {
       for (LifeSavingEquipment nextEnum : LifeSavingEquipment.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum LifeSavingEquipment");
