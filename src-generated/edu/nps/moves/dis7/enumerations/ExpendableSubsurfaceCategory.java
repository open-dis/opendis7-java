 ...
 *  UID 27,
 * marshal size 8;
 * ExpendableSubsurfaceCategory has 7 enumerations total.
...
public enum ExpendableSubsurfaceCategory implements Category
{
     ...
     */
    public static ExpendableSubsurfaceCategory getEnumForValue(int value)
    {
       for (ExpendableSubsurfaceCategory nextEnum : ExpendableSubsurfaceCategory.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum ExpendableSubsurfaceCategory");
