...
public enum TransmitterDetailAmplitudeandAngleModulation 
{
   ...
   public void marshal(DataOutputStream dos) throws IOException
    ...
    public static TransmitterDetailAmplitudeandAngleModulation unmarshalEnum (ByteBuffer byteBuffer) throws Exception
    {
   ...
   */
    ...
    {
        return "TransmitterDetailAmplitudeandAngleModulation " + getValue() + " " + name(); 
    }
}
