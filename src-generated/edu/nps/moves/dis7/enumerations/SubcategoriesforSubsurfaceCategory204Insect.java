...
public enum SubcategoriesforSubsurfaceCategory204Insect implements SubCategory
{
    ...
    public static SubcategoriesforSubsurfaceCategory204Insect unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "SubcategoriesforSubsurfaceCategory204Insect " + getValue() + " " + name(); 
    }
}
