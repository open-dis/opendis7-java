 ...
 *  UID 510,
 * marshal size 8;
 * LifeFormHumanSpecificAntiMaterielRifles has 4 enumerations total.
...
public enum LifeFormHumanSpecificAntiMaterielRifles 
{
    ...
    /** 12.7mm TASKO 7ET3 */
    // autogenerated using string template disenumpart2.txt
    _127MM_TASKO_7ET3 (12, "12.7mm TASKO 7ET3");
     ...
     */
    public static LifeFormHumanSpecificAntiMaterielRifles getEnumForValue(int value)
    {
       for (LifeFormHumanSpecificAntiMaterielRifles nextEnum : LifeFormHumanSpecificAntiMaterielRifles.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum LifeFormHumanSpecificAntiMaterielRifles");
