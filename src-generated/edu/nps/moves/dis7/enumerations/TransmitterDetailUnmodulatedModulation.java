 ...
 *  UID 161,
 * marshal size 16;
 * TransmitterDetailUnmodulatedModulation has 2 enumerations total.
...
public enum TransmitterDetailUnmodulatedModulation 
{
     ...
     */
    public static TransmitterDetailUnmodulatedModulation getEnumForValue(int value)
    {
       for (TransmitterDetailUnmodulatedModulation nextEnum : TransmitterDetailUnmodulatedModulation.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum TransmitterDetailUnmodulatedModulation");
