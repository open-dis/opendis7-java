 ...
 *  UID 409,
 * marshal size 2;
 * AppearanceLinearObjectTankDitchBreach has 4 enumerations total.
...
public enum AppearanceLinearObjectTankDitchBreach 
{
     ...
     */
    public static AppearanceLinearObjectTankDitchBreach getEnumForValue(int value)
    {
       for (AppearanceLinearObjectTankDitchBreach nextEnum : AppearanceLinearObjectTankDitchBreach.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum AppearanceLinearObjectTankDitchBreach");
