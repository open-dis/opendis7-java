...
public enum AppearanceLinearObjectTankDitchBreach 
{
    ...
    public static AppearanceLinearObjectTankDitchBreach unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "AppearanceLinearObjectTankDitchBreach " + getValue() + " " + name(); 
    }
}
