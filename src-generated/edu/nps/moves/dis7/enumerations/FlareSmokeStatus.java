 ...
 *  UID 403,
 * marshal size 2;
 * FlareSmokeStatus has 3 enumerations total.
...
public enum FlareSmokeStatus 
{
     ...
     */
    public static FlareSmokeStatus getEnumForValue(int value)
    {
       for (FlareSmokeStatus nextEnum : FlareSmokeStatus.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum FlareSmokeStatus");
