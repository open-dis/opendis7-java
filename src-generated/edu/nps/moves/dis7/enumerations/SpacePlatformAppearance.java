...
public class SpacePlatformAppearance extends DisBitSet 
{
  ...
  public SpacePlatformAppearance(Bits wh, int value)
  {
    this();
    set(wh,value);
  }
   ...
   * @param value bits of interest
   * @return this object */
  public SpacePlatformAppearance set(Bits wh, int value)
  {
...
*/
   ...
   * @param value bits of interest
   * @return this object */
  public SpacePlatformAppearance set(int start, int length, int value)
  {
