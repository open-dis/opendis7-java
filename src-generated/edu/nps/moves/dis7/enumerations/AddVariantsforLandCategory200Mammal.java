 ...
 *  UID 134,
 * marshal size 8;
 * AddVariantsforLandCategory200Mammal has 6 enumerations total.
...
public enum AddVariantsforLandCategory200Mammal 
{
     ...
     */
    public static AddVariantsforLandCategory200Mammal getEnumForValue(int value)
    {
       for (AddVariantsforLandCategory200Mammal nextEnum : AddVariantsforLandCategory200Mammal.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum AddVariantsforLandCategory200Mammal");
