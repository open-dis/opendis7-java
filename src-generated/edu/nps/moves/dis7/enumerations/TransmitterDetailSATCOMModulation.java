 ...
 *  UID 589,
 * marshal size 16;
 * TransmitterDetailSATCOMModulation has 2 enumerations total.
...
public enum TransmitterDetailSATCOMModulation 
{
     ...
     */
    public static TransmitterDetailSATCOMModulation getEnumForValue(int value)
    {
       for (TransmitterDetailSATCOMModulation nextEnum : TransmitterDetailSATCOMModulation.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum TransmitterDetailSATCOMModulation");
