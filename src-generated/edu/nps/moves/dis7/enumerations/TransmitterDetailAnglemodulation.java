 ...
 *  UID 158,
 * marshal size 16;
 * TransmitterDetailAnglemodulation has 4 enumerations total.
...
public enum TransmitterDetailAnglemodulation 
{
     ...
     */
    public static TransmitterDetailAnglemodulation getEnumForValue(int value)
    {
       for (TransmitterDetailAnglemodulation nextEnum : TransmitterDetailAnglemodulation.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum TransmitterDetailAnglemodulation");
