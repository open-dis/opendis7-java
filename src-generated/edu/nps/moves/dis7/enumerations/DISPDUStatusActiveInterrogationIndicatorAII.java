...
public enum DISPDUStatusActiveInterrogationIndicatorAII 
{
    ...
    public static DISPDUStatusActiveInterrogationIndicatorAII unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "DISPDUStatusActiveInterrogationIndicatorAII " + getValue() + " " + name(); 
    }
}
