 ...
 *  UID 204,
 * marshal size 8;
 * AggregateStateAggregateState has 6 enumerations total.
...
public enum AggregateStateAggregateState 
{
     ...
     */
    public static AggregateStateAggregateState getEnumForValue(int value)
    {
       for (AggregateStateAggregateState nextEnum : AggregateStateAggregateState.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum AggregateStateAggregateState");
