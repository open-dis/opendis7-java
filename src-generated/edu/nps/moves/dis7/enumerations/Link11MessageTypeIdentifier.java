 ...
 *  UID 731,
 * marshal size 8;
 * Link11MessageTypeIdentifier has 7 enumerations total.
...
public enum Link11MessageTypeIdentifier 
{
     ...
     */
    public static Link11MessageTypeIdentifier getEnumForValue(int value)
    {
       for (Link11MessageTypeIdentifier nextEnum : Link11MessageTypeIdentifier.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Link11MessageTypeIdentifier");
