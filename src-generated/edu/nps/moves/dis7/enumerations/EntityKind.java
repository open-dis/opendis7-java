 ...
 *  UID 7,
 * marshal size 8;
 * EntityKind has 11 enumerations total.
...
public enum EntityKind 
{
    ...
    /** Command and Control (C2) Logical Object */
    // autogenerated using string template disenumpart2.txt
    COMMAND_AND_CONTROL_C2_LOGICAL_OBJECT (10, "Command and Control (C2) Logical Object");
     ...
     */
    public static EntityKind getEnumForValue(int value)
    {
       for (EntityKind nextEnum : EntityKind.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum EntityKind");
