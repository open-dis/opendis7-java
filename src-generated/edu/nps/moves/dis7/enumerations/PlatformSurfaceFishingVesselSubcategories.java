...
public enum PlatformSurfaceFishingVesselSubcategories implements SubCategory
{
    ...
    public static PlatformSurfaceFishingVesselSubcategories unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "PlatformSurfaceFishingVesselSubcategories " + getValue() + " " + name(); 
    }
}
