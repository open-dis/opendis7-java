 ...
 * PlatformSurfaceFishingVesselSubcategories has 5 enumerations total.
...
public enum PlatformSurfaceFishingVesselSubcategories implements SubCategory
{
     ...
     */
    public static PlatformSurfaceFishingVesselSubcategories getEnumForValue(int value)
    {
       for (PlatformSurfaceFishingVesselSubcategories nextEnum : PlatformSurfaceFishingVesselSubcategories.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum PlatformSurfaceFishingVesselSubcategories");
