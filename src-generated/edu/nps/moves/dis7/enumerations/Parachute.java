 ...
 *  UID 401,
 * marshal size 2;
 * Parachute has 4 enumerations total.
...
public enum Parachute 
{
     ...
     */
    public static Parachute getEnumForValue(int value)
    {
       for (Parachute nextEnum : Parachute.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Parachute");
