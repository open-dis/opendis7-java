 ...
 *  UID 63,
 * marshal size 8;
 * ServiceRequestServiceTypeRequested has 5 enumerations total.
...
public enum ServiceRequestServiceTypeRequested 
{
     ...
     */
    public static ServiceRequestServiceTypeRequested getEnumForValue(int value)
    {
       for (ServiceRequestServiceTypeRequested nextEnum : ServiceRequestServiceTypeRequested.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum ServiceRequestServiceTypeRequested");
