...
public enum ServiceRequestServiceTypeRequested 
{
    ...
    public static ServiceRequestServiceTypeRequested unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "ServiceRequestServiceTypeRequested " + getValue() + " " + name(); 
    }
}
