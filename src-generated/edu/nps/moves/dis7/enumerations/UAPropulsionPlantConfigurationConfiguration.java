 ...
 *  UID 335,
 * marshal size 7;
 * UAPropulsionPlantConfigurationConfiguration has 7 enumerations total.
...
public enum UAPropulsionPlantConfigurationConfiguration 
{
     ...
     */
    public static UAPropulsionPlantConfigurationConfiguration getEnumForValue(int value)
    {
       for (UAPropulsionPlantConfigurationConfiguration nextEnum : UAPropulsionPlantConfigurationConfiguration.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum UAPropulsionPlantConfigurationConfiguration");
