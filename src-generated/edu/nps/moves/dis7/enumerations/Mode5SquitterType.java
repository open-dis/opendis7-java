 ...
 *  UID 352,
 * marshal size 3;
 * Mode5SquitterType has 3 enumerations total.
...
public enum Mode5SquitterType 
{
     ...
     */
    public static Mode5SquitterType getEnumForValue(int value)
    {
       for (Mode5SquitterType nextEnum : Mode5SquitterType.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Mode5SquitterType");
