 ...
 *  UID 478,
 * marshal size 8;
 * LifeFormAirCategories has 3 enumerations total.
...
public enum LifeFormAirCategories 
{
     ...
     */
    public static LifeFormAirCategories getEnumForValue(int value)
    {
       for (LifeFormAirCategories nextEnum : LifeFormAirCategories.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum LifeFormAirCategories");
