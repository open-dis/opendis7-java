 ...
 *  UID 45,
 * marshal size 8;
 * EntityMarkingCharacterSet has 4 enumerations total.
...
public enum EntityMarkingCharacterSet 
{
     ...
     */
    public static EntityMarkingCharacterSet getEnumForValue(int value)
    {
       for (EntityMarkingCharacterSet nextEnum : EntityMarkingCharacterSet.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum EntityMarkingCharacterSet");
