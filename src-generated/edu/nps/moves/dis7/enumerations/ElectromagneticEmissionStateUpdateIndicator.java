 ...
 *  UID 77,
 * marshal size 8;
 * ElectromagneticEmissionStateUpdateIndicator has 2 enumerations total.
...
public enum ElectromagneticEmissionStateUpdateIndicator 
{
     ...
     */
    public static ElectromagneticEmissionStateUpdateIndicator getEnumForValue(int value)
    {
       for (ElectromagneticEmissionStateUpdateIndicator nextEnum : ElectromagneticEmissionStateUpdateIndicator.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum ElectromagneticEmissionStateUpdateIndicator");
