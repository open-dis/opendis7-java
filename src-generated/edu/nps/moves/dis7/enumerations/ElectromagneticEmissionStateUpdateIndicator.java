...
public enum ElectromagneticEmissionStateUpdateIndicator 
{
    ...
    public static ElectromagneticEmissionStateUpdateIndicator unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "ElectromagneticEmissionStateUpdateIndicator " + getValue() + " " + name(); 
    }
}
