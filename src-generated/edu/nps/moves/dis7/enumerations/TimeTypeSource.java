 ...
 *  UID 367,
 * marshal size 2;
 * TimeTypeSource has 3 enumerations total.
...
public enum TimeTypeSource 
{
     ...
     */
    public static TimeTypeSource getEnumForValue(int value)
    {
       for (TimeTypeSource nextEnum : TimeTypeSource.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum TimeTypeSource");
