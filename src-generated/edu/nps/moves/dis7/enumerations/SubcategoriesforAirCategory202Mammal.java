 ...
 *  UID 112,
 * marshal size 8;
 * SubcategoriesforAirCategory202Mammal has 3 enumerations total.
...
public enum SubcategoriesforAirCategory202Mammal implements SubCategory
{
     ...
     */
    public static SubcategoriesforAirCategory202Mammal getEnumForValue(int value)
    {
       for (SubcategoriesforAirCategory202Mammal nextEnum : SubcategoriesforAirCategory202Mammal.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum SubcategoriesforAirCategory202Mammal");
