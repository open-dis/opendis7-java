...
public enum SubcategoriesforAirCategory202Mammal implements SubCategory
{
    ...
    public static SubcategoriesforAirCategory202Mammal unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "SubcategoriesforAirCategory202Mammal " + getValue() + " " + name(); 
    }
}
