 ...
 *  UID 182,
 * marshal size 8;
 * IntercomControlCommand has 7 enumerations total.
...
public enum IntercomControlCommand 
{
     ...
     */
    public static IntercomControlCommand getEnumForValue(int value)
    {
       for (IntercomControlCommand nextEnum : IntercomControlCommand.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum IntercomControlCommand");
