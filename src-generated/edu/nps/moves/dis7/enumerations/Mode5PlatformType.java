 ...
 *  UID 396,
 * marshal size 1;
 * Mode5PlatformType has 2 enumerations total.
...
public enum Mode5PlatformType 
{
     ...
     */
    public static Mode5PlatformType getEnumForValue(int value)
    {
       for (Mode5PlatformType nextEnum : Mode5PlatformType.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Mode5PlatformType");
