 ...
 *  UID 355,
 * marshal size 1;
 * ModeSSquitterRecordSource has 2 enumerations total.
...
public enum ModeSSquitterRecordSource 
{
     ...
     */
    public static ModeSSquitterRecordSource getEnumForValue(int value)
    {
       for (ModeSSquitterRecordSource nextEnum : ModeSSquitterRecordSource.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum ModeSSquitterRecordSource");
