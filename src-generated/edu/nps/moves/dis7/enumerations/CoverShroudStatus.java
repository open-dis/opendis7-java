 ...
 *  UID 426,
 * marshal size 2;
 * CoverShroudStatus has 4 enumerations total.
...
public enum CoverShroudStatus 
{
     ...
     */
    public static CoverShroudStatus getEnumForValue(int value)
    {
       for (CoverShroudStatus nextEnum : CoverShroudStatus.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum CoverShroudStatus");
