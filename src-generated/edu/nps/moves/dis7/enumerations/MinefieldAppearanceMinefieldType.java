 ...
 *  UID 418,
 * marshal size 2;
 * MinefieldAppearanceMinefieldType has 3 enumerations total.
...
public enum MinefieldAppearanceMinefieldType 
{
     ...
     */
    public static MinefieldAppearanceMinefieldType getEnumForValue(int value)
    {
       for (MinefieldAppearanceMinefieldType nextEnum : MinefieldAppearanceMinefieldType.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum MinefieldAppearanceMinefieldType");
