 ...
 *  UID 319,
 * marshal size 8;
 * EntityAssociationAssociationStatus has 7 enumerations total.
...
public enum EntityAssociationAssociationStatus 
{
     ...
     */
    public static EntityAssociationAssociationStatus getEnumForValue(int value)
    {
       for (EntityAssociationAssociationStatus nextEnum : EntityAssociationAssociationStatus.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum EntityAssociationAssociationStatus");
