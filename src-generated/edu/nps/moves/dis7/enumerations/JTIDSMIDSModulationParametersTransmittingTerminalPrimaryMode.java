 ...
 *  UID 173,
 * marshal size 8;
 * JTIDSMIDSModulationParametersTransmittingTerminalPrimaryMode has 2 enumerations total.
...
public enum JTIDSMIDSModulationParametersTransmittingTerminalPrimaryMode 
{
     ...
     */
    public static JTIDSMIDSModulationParametersTransmittingTerminalPrimaryMode getEnumForValue(int value)
    {
       for (JTIDSMIDSModulationParametersTransmittingTerminalPrimaryMode nextEnum : JTIDSMIDSModulationParametersTransmittingTerminalPrimaryMode.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum JTIDSMIDSModulationParametersTransmittingTerminalPrimaryMode");
