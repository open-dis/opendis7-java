...
public enum Class11SupplyCategorySuppliesNonDoctrinal implements Category
{
     ...
     */
    public static Class11SupplyCategorySuppliesNonDoctrinal getEnumForValue(int value)
    {
       for (Class11SupplyCategorySuppliesNonDoctrinal nextEnum : Class11SupplyCategorySuppliesNonDoctrinal.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Class11SupplyCategorySuppliesNonDoctrinal");
