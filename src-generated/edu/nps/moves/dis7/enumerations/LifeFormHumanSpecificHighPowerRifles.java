 ...
 *  UID 475,
 * marshal size 8;
 * LifeFormHumanSpecificHighPowerRifles has 10 enumerations total.
...
public enum LifeFormHumanSpecificHighPowerRifles 
{
     ...
     */
    public static LifeFormHumanSpecificHighPowerRifles getEnumForValue(int value)
    {
       for (LifeFormHumanSpecificHighPowerRifles nextEnum : LifeFormHumanSpecificHighPowerRifles.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum LifeFormHumanSpecificHighPowerRifles");
