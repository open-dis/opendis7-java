...
;
    ...
    public static PlatformSubsurfaceCivilianSubmarineSubcategories unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "PlatformSubsurfaceCivilianSubmarineSubcategories " + getValue() + " " + name(); 
    }
}
