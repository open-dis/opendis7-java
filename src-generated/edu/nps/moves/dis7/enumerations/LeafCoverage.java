 ...
 *  UID 509,
 * marshal size 2;
 * LeafCoverage has 2 enumerations total.
...
public enum LeafCoverage 
{
     ...
     */
    public static LeafCoverage getEnumForValue(int value)
    {
       for (LeafCoverage nextEnum : LeafCoverage.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum LeafCoverage");
