 ...
 *  UID 332,
 * marshal size 8;
 * OwnershipStatus has 7 enumerations total.
...
public enum OwnershipStatus 
{
    ...
    /** Local Entity Cancelled - Remove Entity TO Received */
    // autogenerated using string template disenumpart2.txt
    LOCAL_ENTITY_CANCELLED_REMOVE_ENTITY_TO_RECEIVED (6, "Local Entity Cancelled - Remove Entity TO Received");
     ...
     */
    public static OwnershipStatus getEnumForValue(int value)
    {
       for (OwnershipStatus nextEnum : OwnershipStatus.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum OwnershipStatus");
