...
public enum PlatformAirCivilianGliderSubcategories implements SubCategory
{
    ...
    public static PlatformAirCivilianGliderSubcategories unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "PlatformAirCivilianGliderSubcategories " + getValue() + " " + name(); 
    }
}
