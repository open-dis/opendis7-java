 ...
 *  UID 104,
 * marshal size 8;
 * SubcategoriesforLandCategory204Arachnid has 5 enumerations total.
...
public enum SubcategoriesforLandCategory204Arachnid implements SubCategory
{
     ...
     */
    public static SubcategoriesforLandCategory204Arachnid getEnumForValue(int value)
    {
       for (SubcategoriesforLandCategory204Arachnid nextEnum : SubcategoriesforLandCategory204Arachnid.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum SubcategoriesforLandCategory204Arachnid");
