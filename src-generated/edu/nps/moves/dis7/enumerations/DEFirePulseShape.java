 ...
 *  UID 312,
 * marshal size 8;
 * DEFirePulseShape has 4 enumerations total.
...
public enum DEFirePulseShape 
{
     ...
     */
    public static DEFirePulseShape getEnumForValue(int value)
    {
       for (DEFirePulseShape nextEnum : DEFirePulseShape.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum DEFirePulseShape");
