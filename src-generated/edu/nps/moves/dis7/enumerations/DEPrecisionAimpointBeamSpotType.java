 ...
 *  UID 311,
 * marshal size 8;
 * DEPrecisionAimpointBeamSpotType has 3 enumerations total.
...
public enum DEPrecisionAimpointBeamSpotType 
{
     ...
     */
    public static DEPrecisionAimpointBeamSpotType getEnumForValue(int value)
    {
       for (DEPrecisionAimpointBeamSpotType nextEnum : DEPrecisionAimpointBeamSpotType.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum DEPrecisionAimpointBeamSpotType");
