 ...
 *  UID 603,
 * marshal size 8;
 * Class3SupplyCategoryPetroleumOilsLubricants has 4 enumerations total.
...
public enum Class3SupplyCategoryPetroleumOilsLubricants implements Category
{
     ...
     */
    public static Class3SupplyCategoryPetroleumOilsLubricants getEnumForValue(int value)
    {
       for (Class3SupplyCategoryPetroleumOilsLubricants nextEnum : Class3SupplyCategoryPetroleumOilsLubricants.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Class3SupplyCategoryPetroleumOilsLubricants");
