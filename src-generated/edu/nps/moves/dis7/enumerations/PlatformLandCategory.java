 ...
 *  UID 9,
 * marshal size 8;
 * PlatformLandCategory has 59 enumerations total.
...
public enum PlatformLandCategory implements Category
{
    ...
    // autogenerated using string template disenumpart2.txt
    UNDERWATER_ACOUSTIC (29, "Command, Control, Communications, and Intelligence (C3I) System"),
    // autogenerated using string template disenumfootnotecomment.txt
    ...
    /** Fixed Barrel/Turret Gun, Howtizers and Air Defense guns that aren't mounted on any vehicle or trailer. */
    // autogenerated using string template disenumpart2.txt
    FIXED_BARREL_TURRET_GUN (42, "Fixed Barrel/Turret Gun"),
    // autogenerated using string template disenumfootnotecomment.txt

    /** Fixed Missile Launcher, Missile launchers that aren't mounted on any vehicle or trailer. */
    // autogenerated using string template disenumpart2.txt
    FIXED_MISSILE_LAUNCHER (43, "Fixed Missile Launcher"),
    // autogenerated using string template disenumfootnotecomment.txt
