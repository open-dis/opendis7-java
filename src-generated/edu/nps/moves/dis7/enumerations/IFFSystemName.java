 ...
 *  UID 83,
 * marshal size 16;
 * IFFSystemName has 19 enumerations total.
...
public enum IFFSystemName 
{
     ...
     */
    public static IFFSystemName getEnumForValue(int value)
    {
       for (IFFSystemName nextEnum : IFFSystemName.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum IFFSystemName");
