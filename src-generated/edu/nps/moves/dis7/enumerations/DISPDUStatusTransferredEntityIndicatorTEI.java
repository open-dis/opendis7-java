...
public enum DISPDUStatusTransferredEntityIndicatorTEI 
{
    ...
    public static DISPDUStatusTransferredEntityIndicatorTEI unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "DISPDUStatusTransferredEntityIndicatorTEI " + getValue() + " " + name(); 
    }
}
