 ...
 *  UID 376,
 * marshal size 2;
 * ComponentVisualDamageStatusSurfaceDamage has 4 enumerations total.
...
public enum ComponentVisualDamageStatusSurfaceDamage 
{
     ...
     */
    public static ComponentVisualDamageStatusSurfaceDamage getEnumForValue(int value)
    {
       for (ComponentVisualDamageStatusSurfaceDamage nextEnum : ComponentVisualDamageStatusSurfaceDamage.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum ComponentVisualDamageStatusSurfaceDamage");
