 ...
 *  UID 375,
 * marshal size 2;
 * ComponentVisualDamageStatusSmoke has 4 enumerations total.
...
public enum ComponentVisualDamageStatusSmoke 
{
     ...
     */
    public static ComponentVisualDamageStatusSmoke getEnumForValue(int value)
    {
       for (ComponentVisualDamageStatusSmoke nextEnum : ComponentVisualDamageStatusSmoke.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum ComponentVisualDamageStatusSmoke");
