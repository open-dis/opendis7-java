 ...
 *  UID 320,
 * marshal size 8;
 * EntityVPRecordChangeIndicator has 2 enumerations total.
...
public enum EntityVPRecordChangeIndicator 
{
     ...
     */
    public static EntityVPRecordChangeIndicator getEnumForValue(int value)
    {
       for (EntityVPRecordChangeIndicator nextEnum : EntityVPRecordChangeIndicator.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum EntityVPRecordChangeIndicator");
