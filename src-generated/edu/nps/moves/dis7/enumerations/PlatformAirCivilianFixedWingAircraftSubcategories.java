 ...
 * PlatformAirCivilianFixedWingAircraftSubcategories has 12 enumerations total.
...
public enum PlatformAirCivilianFixedWingAircraftSubcategories implements SubCategory
{
    ...
    // autogenerated using string template disenumpart2.txt
    DESIGNATOR (24, "Four Engine Turboprop"),
    // autogenerated using string template disenumfootnotecomment.txt
    ...
    /** Twin Engine Tilt-Rotor */
    // autogenerated using string template disenumpart2.txt
    TWIN_ENGINE_TILT_ROTOR (40, "Twin Engine Tilt-Rotor"),
    // autogenerated using string template disenumfootnotecomment.txt

    /** Tri Engine Tilt-Rotor */
    // autogenerated using string template disenumpart2.txt
    TRI_ENGINE_TILT_ROTOR (41, "Tri Engine Tilt-Rotor"),
    // autogenerated using string template disenumfootnotecomment.txt

    /** Four Engine Tilt-Rotor */
    // autogenerated using string template disenumpart2.txt
    FOUR_ENGINE_TILT_ROTOR (42, "Four Engine Tilt-Rotor"),
    // autogenerated using string template disenumfootnotecomment.txt

    /** Six Engine Tilt-Rotor */
    // autogenerated using string template disenumpart2.txt
    SIX_ENGINE_TILT_ROTOR (43, "Six Engine Tilt-Rotor");
