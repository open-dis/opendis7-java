 ...
 *  UID 359,
 * marshal size 8;
 * NavigationSource has 4 enumerations total.
...
public enum NavigationSource 
{
     ...
     */
    public static NavigationSource getEnumForValue(int value)
    {
       for (NavigationSource nextEnum : NavigationSource.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum NavigationSource");
