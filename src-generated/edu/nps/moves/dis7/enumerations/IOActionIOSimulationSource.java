 ...
 *  UID 286, marshal size 16;
 * IOActionIOSimulationSource has 1 enumerations total.
...
public enum IOActionIOSimulationSource 
{
     ...
     */
    public static IOActionIOSimulationSource getEnumForValue(int value)
    {
       for (IOActionIOSimulationSource nextEnum : IOActionIOSimulationSource.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum IOActionIOSimulationSource");
