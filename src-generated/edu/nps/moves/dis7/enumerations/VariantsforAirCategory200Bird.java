 ...
 *  UID 136,
 * marshal size 8;
 * VariantsforAirCategory200Bird has 4 enumerations total.
...
public enum VariantsforAirCategory200Bird 
{
     ...
     */
    public static VariantsforAirCategory200Bird getEnumForValue(int value)
    {
       for (VariantsforAirCategory200Bird nextEnum : VariantsforAirCategory200Bird.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum VariantsforAirCategory200Bird");
