 ...
 *  UID 402,
 * marshal size 3;
 * FlareSmokeColor has 4 enumerations total.
...
public enum FlareSmokeColor 
{
     ...
     */
    public static FlareSmokeColor getEnumForValue(int value)
    {
       for (FlareSmokeColor nextEnum : FlareSmokeColor.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum FlareSmokeColor");
