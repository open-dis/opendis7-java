 ...
 *  UID 78,
 * marshal size 8;
 * ElectromagneticEmissionBeamFunction has 25 enumerations total.
...
public enum ElectromagneticEmissionBeamFunction 
{
    ...
    /** Ground Mapping */
    // autogenerated using string template disenumpart2.txt
    GROUND_MAPPING (19, "Ground Mapping"),
    // autogenerated using string template disenumfootnotecomment.txt
    ...
    // autogenerated using string template disenumpart2.txt
    DESIGNATOR (24, "Time-Shared Illumination"),
    // autogenerated using string template disenumfootnotecomment.txt
     ...
     */
    public static ElectromagneticEmissionBeamFunction getEnumForValue(int value)
    {
       for (ElectromagneticEmissionBeamFunction nextEnum : ElectromagneticEmissionBeamFunction.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum ElectromagneticEmissionBeamFunction");
