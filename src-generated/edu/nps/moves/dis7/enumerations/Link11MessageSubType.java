 ...
 *  UID 730,
 * marshal size 8;
 * Link11MessageSubType has 5 enumerations total.
...
public enum Link11MessageSubType 
{
     ...
     */
    public static Link11MessageSubType getEnumForValue(int value)
    {
       for (Link11MessageSubType nextEnum : Link11MessageSubType.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Link11MessageSubType");
