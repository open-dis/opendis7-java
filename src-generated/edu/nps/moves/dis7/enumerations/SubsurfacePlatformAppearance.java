...
public class SubsurfacePlatformAppearance extends DisBitSet 
{
  ...
  // autogenerated using string template disbitsetcomment.txt
  /**
   * (bit position 16, boolean) Describes whether the periscope is extended or not
   */
  // autogenerated using string template disbitset15.txt
  public static Bits PERISCOPE = new Bits(16, 1);

  // autogenerated using string template disbitsetcomment.txt
  /**
   * (bit position 17, boolean) Describes whether the snorkel is extended or not
   */
  // autogenerated using string template disbitset15.txt
  public static Bits SNORKEL = new Bits(17, 1);

  // autogenerated using string template disbitsetcomment.txt
  /**
   * (bit position 18, boolean) Describes whether the radar mast is extended or not
   */
  // autogenerated using string template disbitset15.txt
  public static Bits RADARMAST = new Bits(18, 1);

  // autogenerated using string template disbitsetcomment.txt
  /**
   * (bit position 19, boolean) Describes whether the communication mast is extended or not
   */
  // autogenerated using string template disbitset15.txt
  public static Bits COMMSMAST = new Bits(19, 1);

  // autogenerated using string template disbitsetcomment.txt
  /**
   * (bit position 20, boolean) Describes whether the ESM mast is extended or not
   */
  // autogenerated using string template disbitset15.txt
  public static Bits ESMMAST = new Bits(20, 1);
  ...
  // autogenerated using string template disbitsetcomment.txt
  /**
   * (bit position 25, boolean) Describes whether the torpedo tubes are open or not
   */
  // autogenerated using string template disbitset15.txt
  public static Bits TORPEDOTUBES = new Bits(25, 1);

  // autogenerated using string template disbitsetcomment.txt
  /**
   * (bit position 26, boolean) Describes whether the missile hatches are open or not
   */
  // autogenerated using string template disbitset15.txt
  public static Bits MISSILEHATCHES = new Bits(26, 1);

  // autogenerated using string template disbitsetcomment.txt
  /**
   * (bit position 27, boolean) Describes whether the TAS is deployed or not
   */
  // autogenerated using string template disbitset15.txt
  public static Bits TOWEDARRAYSONAR = new Bits(27, 1);
