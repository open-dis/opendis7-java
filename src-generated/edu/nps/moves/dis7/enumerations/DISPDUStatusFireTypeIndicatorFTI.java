...
public enum DISPDUStatusFireTypeIndicatorFTI 
{
    ...
    public static DISPDUStatusFireTypeIndicatorFTI unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "DISPDUStatusFireTypeIndicatorFTI " + getValue() + " " + name(); 
    }
}
