 ...
 *  UID 304,
 * marshal size 1;
 * DISPDUStatusFireTypeIndicator(FTI) has 2 enumerations total.
...
public enum DISPDUStatusFireTypeIndicatorFTI 
{
     ...
     */
    public static DISPDUStatusFireTypeIndicatorFTI getEnumForValue(int value)
    {
       for (DISPDUStatusFireTypeIndicatorFTI nextEnum : DISPDUStatusFireTypeIndicatorFTI.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum DISPDUStatusFireTypeIndicatorFTI");
