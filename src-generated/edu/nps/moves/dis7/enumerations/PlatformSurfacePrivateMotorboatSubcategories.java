...
public enum PlatformSurfacePrivateMotorboatSubcategories implements SubCategory
{
    ...
    public static PlatformSurfacePrivateMotorboatSubcategories unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "PlatformSurfacePrivateMotorboatSubcategories " + getValue() + " " + name(); 
    }
}
