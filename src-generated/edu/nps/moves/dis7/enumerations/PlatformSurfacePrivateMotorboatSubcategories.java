 ...
 * PlatformSurfacePrivateMotorboatSubcategories has 4 enumerations total.
...
public enum PlatformSurfacePrivateMotorboatSubcategories implements SubCategory
{
     ...
     */
    public static PlatformSurfacePrivateMotorboatSubcategories getEnumForValue(int value)
    {
       for (PlatformSurfacePrivateMotorboatSubcategories nextEnum : PlatformSurfacePrivateMotorboatSubcategories.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum PlatformSurfacePrivateMotorboatSubcategories");
