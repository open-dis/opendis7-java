 ...
 *  UID 388,
 * marshal size 3;
 * AppearanceSubsurfaceHatch has 3 enumerations total.
...
public enum AppearanceSubsurfaceHatch 
{
     ...
     */
    public static AppearanceSubsurfaceHatch getEnumForValue(int value)
    {
       for (AppearanceSubsurfaceHatch nextEnum : AppearanceSubsurfaceHatch.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum AppearanceSubsurfaceHatch");
