 ...
 *  UID 282,
 * marshal size 8;
 * SeparationVPReasonforSeparation has 3 enumerations total.
...
public enum SeparationVPReasonforSeparation 
{
     ...
     */
    public static SeparationVPReasonforSeparation getEnumForValue(int value)
    {
       for (SeparationVPReasonforSeparation nextEnum : SeparationVPReasonforSeparation.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum SeparationVPReasonforSeparation");
