...
public enum DISPDUStatusIntercomAttachedIndicatorIAI 
{
    ...
    public static DISPDUStatusIntercomAttachedIndicatorIAI unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "DISPDUStatusIntercomAttachedIndicatorIAI " + getValue() + " " + name(); 
    }
}
