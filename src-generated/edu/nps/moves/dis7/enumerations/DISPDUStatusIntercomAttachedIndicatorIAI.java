 ...
 *  UID 307,
 * marshal size 2;
 * DISPDUStatusIntercomAttachedIndicator(IAI) has 3 enumerations total.
...
public enum DISPDUStatusIntercomAttachedIndicatorIAI 
{
     ...
     */
    public static DISPDUStatusIntercomAttachedIndicatorIAI getEnumForValue(int value)
    {
       for (DISPDUStatusIntercomAttachedIndicatorIAI nextEnum : DISPDUStatusIntercomAttachedIndicatorIAI.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum DISPDUStatusIntercomAttachedIndicatorIAI");
