...
public class PointObjectAppearanceRibbonBridge extends DisBitSet 
{
  ...
  public PointObjectAppearanceRibbonBridge(Bits wh, int value)
  {
    this();
    set(wh,value);
  }
   ...
   * @param value bits of interest
   * @return this object */
  public PointObjectAppearanceRibbonBridge set(Bits wh, int value)
  {
...
*/
   ...
   * @param value bits of interest
   * @return this object */
  public PointObjectAppearanceRibbonBridge set(int start, int length, int value)
  {
