 ...
 *  UID 294,
 * marshal size 8;
 * IOCommsNodeRecordCommsNodeType has 4 enumerations total.
...
public enum IOCommsNodeRecordCommsNodeType 
{
     ...
     */
    public static IOCommsNodeRecordCommsNodeType getEnumForValue(int value)
    {
       for (IOCommsNodeRecordCommsNodeType nextEnum : IOCommsNodeRecordCommsNodeType.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum IOCommsNodeRecordCommsNodeType");
