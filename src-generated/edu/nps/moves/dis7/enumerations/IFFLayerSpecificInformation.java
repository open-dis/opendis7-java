 ...
 *  UID 87,
 * marshal size 8;
 * IFFLayerSpecificInformation has 1 enumerations total.
...
public enum IFFLayerSpecificInformation 
{
     ...
     */
    public static IFFLayerSpecificInformation getEnumForValue(int value)
    {
       for (IFFLayerSpecificInformation nextEnum : IFFLayerSpecificInformation.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum IFFLayerSpecificInformation");
