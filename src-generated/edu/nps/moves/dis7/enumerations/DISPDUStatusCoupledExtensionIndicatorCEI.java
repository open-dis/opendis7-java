 ...
 *  UID 303,
 * marshal size 1;
 * DISPDUStatusCoupledExtensionIndicator(CEI) has 2 enumerations total.
...
public enum DISPDUStatusCoupledExtensionIndicatorCEI 
{
     ...
     */
    public static DISPDUStatusCoupledExtensionIndicatorCEI getEnumForValue(int value)
    {
       for (DISPDUStatusCoupledExtensionIndicatorCEI nextEnum : DISPDUStatusCoupledExtensionIndicatorCEI.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum DISPDUStatusCoupledExtensionIndicatorCEI");
