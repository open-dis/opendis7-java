...
public enum DISPDUStatusCoupledExtensionIndicatorCEI 
{
    ...
    public static DISPDUStatusCoupledExtensionIndicatorCEI unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "DISPDUStatusCoupledExtensionIndicatorCEI " + getValue() + " " + name(); 
    }
}
