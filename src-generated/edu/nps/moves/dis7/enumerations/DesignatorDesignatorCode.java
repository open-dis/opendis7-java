 ...
 * DesignatorDesignatorCode has 1 enumerations total.
...
public enum DesignatorDesignatorCode 
{
     ...
     */
    public static DesignatorDesignatorCode getEnumForValue(int value)
    {
       for (DesignatorDesignatorCode nextEnum : DesignatorDesignatorCode.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum DesignatorDesignatorCode");
