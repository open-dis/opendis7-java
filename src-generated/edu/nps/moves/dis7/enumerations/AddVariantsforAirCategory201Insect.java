 ...
 *  UID 137,
 * marshal size 8;
 * AddVariantsforAirCategory201Insect has 3 enumerations total.
...
public enum AddVariantsforAirCategory201Insect 
{
     ...
     */
    public static AddVariantsforAirCategory201Insect getEnumForValue(int value)
    {
       for (AddVariantsforAirCategory201Insect nextEnum : AddVariantsforAirCategory201Insect.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum AddVariantsforAirCategory201Insect");
