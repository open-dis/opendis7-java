 ...
 *  UID 404,
 * marshal size 2;
 * SpotChaffStatus has 3 enumerations total.
...
public enum SpotChaffStatus 
{
     ...
     */
    public static SpotChaffStatus getEnumForValue(int value)
    {
       for (SpotChaffStatus nextEnum : SpotChaffStatus.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum SpotChaffStatus");
