 ...
 *  UID 500,
 * marshal size 8;
 * AustralianCategoryOverlay has 6 enumerations total.
...
public enum AustralianCategoryOverlay 
{
     ...
     */
    public static AustralianCategoryOverlay getEnumForValue(int value)
    {
       for (AustralianCategoryOverlay nextEnum : AustralianCategoryOverlay.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum AustralianCategoryOverlay");
