 ...
 *  UID 283,
 * marshal size 8;
 * SeparationVPPreEntityIndicator has 4 enumerations total.
...
public enum SeparationVPPreEntityIndicator 
{
     ...
     */
    public static SeparationVPPreEntityIndicator getEnumForValue(int value)
    {
       for (SeparationVPPreEntityIndicator nextEnum : SeparationVPPreEntityIndicator.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum SeparationVPPreEntityIndicator");
