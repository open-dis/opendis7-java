 ...
 * Link11SignalIntegrationInterval has 3 enumerations total.
...
public enum Link11SignalIntegrationInterval 
{
     ...
     */
    public static Link11SignalIntegrationInterval getEnumForValue(int value)
    {
       for (Link11SignalIntegrationInterval nextEnum : Link11SignalIntegrationInterval.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Link11SignalIntegrationInterval");
