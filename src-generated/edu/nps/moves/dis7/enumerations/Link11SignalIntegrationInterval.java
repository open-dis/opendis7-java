...
public enum Link11SignalIntegrationInterval 
{
    ...
    public static Link11SignalIntegrationInterval unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "Link11SignalIntegrationInterval " + getValue() + " " + name(); 
    }
}
