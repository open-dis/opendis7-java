 ...
 *  UID 340,
 * marshal size 1;
 * ModeCAltitudeIndicator has 2 enumerations total.
...
public enum ModeCAltitudeIndicator 
{
     ...
     */
    public static ModeCAltitudeIndicator getEnumForValue(int value)
    {
       for (ModeCAltitudeIndicator nextEnum : ModeCAltitudeIndicator.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum ModeCAltitudeIndicator");
