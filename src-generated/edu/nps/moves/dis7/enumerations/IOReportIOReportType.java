 ...
 *  UID 289,
 * marshal size 8;
 * IOReportIOReportType has 4 enumerations total.
...
public enum IOReportIOReportType 
{
     ...
     */
    public static IOReportIOReportType getEnumForValue(int value)
    {
       for (IOReportIOReportType nextEnum : IOReportIOReportType.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum IOReportIOReportType");
