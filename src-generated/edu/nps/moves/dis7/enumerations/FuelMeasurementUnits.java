 ...
 *  UID 328,
 * marshal size 8;
 * FuelMeasurementUnits has 3 enumerations total.
...
public enum FuelMeasurementUnits 
{
     ...
     */
    public static FuelMeasurementUnits getEnumForValue(int value)
    {
       for (FuelMeasurementUnits nextEnum : FuelMeasurementUnits.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum FuelMeasurementUnits");
