 ...
 *  UID 69,
 * marshal size 16;
 * AcknowledgeAcknowledgeFlag has 5 enumerations total.
...
public enum AcknowledgeAcknowledgeFlag 
{
     ...
     */
    public static AcknowledgeAcknowledgeFlag getEnumForValue(int value)
    {
       for (AcknowledgeAcknowledgeFlag nextEnum : AcknowledgeAcknowledgeFlag.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum AcknowledgeAcknowledgeFlag");
