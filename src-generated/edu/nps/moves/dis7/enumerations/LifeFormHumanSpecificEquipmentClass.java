...
public enum LifeFormHumanSpecificEquipmentClass 
{
    ...
    public static LifeFormHumanSpecificEquipmentClass unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "LifeFormHumanSpecificEquipmentClass " + getValue() + " " + name(); 
    }
}
