 ...
 *  UID 505,
 * marshal size 8;
 * LifeFormHumanSpecificEquipmentClass has 5 enumerations total.
...
public enum LifeFormHumanSpecificEquipmentClass 
{
     ...
     */
    public static LifeFormHumanSpecificEquipmentClass getEnumForValue(int value)
    {
       for (LifeFormHumanSpecificEquipmentClass nextEnum : LifeFormHumanSpecificEquipmentClass.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum LifeFormHumanSpecificEquipmentClass");
