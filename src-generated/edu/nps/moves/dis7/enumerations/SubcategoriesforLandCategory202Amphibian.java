 ...
 *  UID 102,
 * marshal size 8;
 * SubcategoriesforLandCategory202Amphibian has 4 enumerations total.
...
public enum SubcategoriesforLandCategory202Amphibian implements SubCategory
{
     ...
     */
    public static SubcategoriesforLandCategory202Amphibian getEnumForValue(int value)
    {
       for (SubcategoriesforLandCategory202Amphibian nextEnum : SubcategoriesforLandCategory202Amphibian.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum SubcategoriesforLandCategory202Amphibian");
