 ...
 *  UID 74,
 * marshal size 8;
 * RequiredReliabilityService has 2 enumerations total.
...
public enum RequiredReliabilityService 
{
     ...
     */
    public static RequiredReliabilityService getEnumForValue(int value)
    {
       for (RequiredReliabilityService nextEnum : RequiredReliabilityService.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum RequiredReliabilityService");
