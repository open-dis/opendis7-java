 ...
 *  UID 144,
 * marshal size 16;
 * UAAcousticSystemName has 10 enumerations total.
...
public enum UAAcousticSystemName 
{
     ...
     */
    public static UAAcousticSystemName getEnumForValue(int value)
    {
       for (UAAcousticSystemName nextEnum : UAAcousticSystemName.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum UAAcousticSystemName");
