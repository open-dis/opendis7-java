 ...
 *  UID 373,
 * marshal size 8;
 * ReplyAmplification has 4 enumerations total.
...
public enum ReplyAmplification 
{
     ...
     */
    public static ReplyAmplification getEnumForValue(int value)
    {
       for (ReplyAmplification nextEnum : ReplyAmplification.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum ReplyAmplification");
