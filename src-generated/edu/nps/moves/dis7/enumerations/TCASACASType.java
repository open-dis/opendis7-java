 ...
 *  UID 344,
 * marshal size 3;
 * TCASACASType has 3 enumerations total.
...
public enum TCASACASType 
{
     ...
     */
    public static TCASACASType getEnumForValue(int value)
    {
       for (TCASACASType nextEnum : TCASACASType.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum TCASACASType");
