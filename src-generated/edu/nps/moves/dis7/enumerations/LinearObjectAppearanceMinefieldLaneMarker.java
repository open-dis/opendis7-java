...
public class LinearObjectAppearanceMinefieldLaneMarker extends DisBitSet 
{
  ...
  public LinearObjectAppearanceMinefieldLaneMarker(Bits wh, int value)
  {
    this();
    set(wh,value);
  }
   ...
   * @param value bits of interest
   * @return this object */
  public LinearObjectAppearanceMinefieldLaneMarker set(Bits wh, int value)
  {
...
*/
   ...
   * @param value bits of interest
   * @return this object */
  public LinearObjectAppearanceMinefieldLaneMarker set(int start, int length, int value)
  {
