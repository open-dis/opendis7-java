 ...
 *  UID 8,
 * marshal size 8;
 * PlatformDomain has 6 enumerations total.
...
public enum PlatformDomain 
{
     ...
     */
    public static PlatformDomain getEnumForValue(int value)
    {
       for (PlatformDomain nextEnum : PlatformDomain.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum PlatformDomain");
