...
public enum RepairCompleteRepair 
{
     ...
     */
    public static RepairCompleteRepair getEnumForValue(int value)
    {
       for (RepairCompleteRepair nextEnum : RepairCompleteRepair.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum RepairCompleteRepair");
