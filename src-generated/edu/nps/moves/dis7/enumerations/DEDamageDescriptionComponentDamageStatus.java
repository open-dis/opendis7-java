 ...
 *  UID 315,
 * marshal size 8;
 * DEDamageDescriptionComponentDamageStatus has 5 enumerations total.
...
public enum DEDamageDescriptionComponentDamageStatus 
{
     ...
     */
    public static DEDamageDescriptionComponentDamageStatus getEnumForValue(int value)
    {
       for (DEDamageDescriptionComponentDamageStatus nextEnum : DEDamageDescriptionComponentDamageStatus.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum DEDamageDescriptionComponentDamageStatus");
