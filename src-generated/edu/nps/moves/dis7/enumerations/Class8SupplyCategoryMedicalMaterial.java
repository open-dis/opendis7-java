 ...
 *  UID 608,
 * marshal size 8;
 * Class8SupplyCategoryMedicalMaterial has 3 enumerations total.
...
public enum Class8SupplyCategoryMedicalMaterial implements Category
{
     ...
     */
    public static Class8SupplyCategoryMedicalMaterial getEnumForValue(int value)
    {
       for (Class8SupplyCategoryMedicalMaterial nextEnum : Class8SupplyCategoryMedicalMaterial.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Class8SupplyCategoryMedicalMaterial");
