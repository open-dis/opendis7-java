 ...
 *  UID 272,
 * marshal size 8;
 * RepairGroups has 10 enumerations total.
...
public enum RepairGroups 
{
     ...
     */
    public static RepairGroups getEnumForValue(int value)
    {
       for (RepairGroups nextEnum : RepairGroups.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum RepairGroups");
