 ...
 *  UID 358,
 * marshal size 8;
 * CapabilityReport has 9 enumerations total.
...
public enum CapabilityReport 
{
     ...
     */
    public static CapabilityReport getEnumForValue(int value)
    {
       for (CapabilityReport nextEnum : CapabilityReport.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum CapabilityReport");
