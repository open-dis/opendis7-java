 ...
 *  UID 247,
 * marshal size 16;
 * GriddedDataDataRepresentation has 3 enumerations total.
...
public enum GriddedDataDataRepresentation 
{
     ...
     */
    public static GriddedDataDataRepresentation getEnumForValue(int value)
    {
       for (GriddedDataDataRepresentation nextEnum : GriddedDataDataRepresentation.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum GriddedDataDataRepresentation");
