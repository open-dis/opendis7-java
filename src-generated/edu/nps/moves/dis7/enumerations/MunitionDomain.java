...
public enum MunitionDomain 
{
    ...
    /** Strategic, Used for Intermediate-range (IRBM - 3500-5500 km range) and Intercontinental (ICBM - &gt;5500 km range) ballistic missiles */
    // autogenerated using string template disenumpart2.txt
    STRATEGIC (10, "Strategic"),
    // autogenerated using string template disenumfootnotecomment.txt

    /** Tactical, Used for Tactical (&lt;300 km range), Short-range (SRBM - 300-1000 km range), and Medium-range (MRBM - 1000-3500 km range) ballistic missiles */
    // autogenerated using string template disenumpart2.txt
     ...
     */
    public static MunitionDomain getEnumForValue(int value)
    {
       for (MunitionDomain nextEnum : MunitionDomain.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum MunitionDomain");
