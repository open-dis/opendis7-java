...
public enum AppearanceObjectSpecificChemicalType 
{
    ...
    public static AppearanceObjectSpecificChemicalType unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "AppearanceObjectSpecificChemicalType " + getValue() + " " + name(); 
    }
}
