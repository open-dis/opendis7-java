 ...
 *  UID 408,
 * marshal size 2;
 * AppearanceObjectSpecificChemicalType has 4 enumerations total.
...
public enum AppearanceObjectSpecificChemicalType 
{
     ...
     */
    public static AppearanceObjectSpecificChemicalType getEnumForValue(int value)
    {
       for (AppearanceObjectSpecificChemicalType nextEnum : AppearanceObjectSpecificChemicalType.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum AppearanceObjectSpecificChemicalType");
