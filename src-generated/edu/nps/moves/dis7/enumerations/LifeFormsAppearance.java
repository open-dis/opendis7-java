...
public class LifeFormsAppearance extends DisBitSet 
{
  ...
  /**
   * (bit position 1, boolean) Describes whether a weapon which holds a launched munition (Rocket/Missile) is loaded
   */
  // autogenerated using string template disbitset15.txt
  public static Bits ROCKETMISSILEMUNITIONPRESENT = new Bits(1, 1);
   ...
   */
  // autogenerated using string template disbitset16.txt
  public static Bits CLOTHINGIRSIGNATURE = new Bits(9, 2, ClothingIRSignature.class);
   ...
   */
  // autogenerated using string template disbitset15.txt
  public static Bits ISSMOKINGCIGARETTE = new Bits(20, 1);
