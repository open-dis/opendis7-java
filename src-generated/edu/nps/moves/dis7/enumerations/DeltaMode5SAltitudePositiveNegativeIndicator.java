 ...
 *  UID 362,
 * marshal size 1;
 * DeltaMode5SAltitudePositiveNegativeIndicator has 2 enumerations total.
...
public enum DeltaMode5SAltitudePositiveNegativeIndicator 
{
     ...
     */
    public static DeltaMode5SAltitudePositiveNegativeIndicator getEnumForValue(int value)
    {
       for (DeltaMode5SAltitudePositiveNegativeIndicator nextEnum : DeltaMode5SAltitudePositiveNegativeIndicator.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum DeltaMode5SAltitudePositiveNegativeIndicator");
