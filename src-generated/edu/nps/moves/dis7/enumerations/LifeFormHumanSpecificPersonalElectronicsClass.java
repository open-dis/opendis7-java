 ...
 *  UID 526,
 * marshal size 8;
 * LifeFormHumanSpecificPersonalElectronicsClass has 3 enumerations total.
...
public enum LifeFormHumanSpecificPersonalElectronicsClass 
{
    ...
    /** Radio/Telephone Pack */
    // autogenerated using string template disenumpart2.txt
    RADIO_TELEPHONE_PACK (2, "Radio/Telephone Pack"),
    // autogenerated using string template disenumfootnotecomment.txt

    /** UAV/UAS Remote Controller */
    // autogenerated using string template disenumpart2.txt
    UAV_UAS_REMOTE_CONTROLLER (3, "UAV/UAS Remote Controller");
     ...
     */
    public static LifeFormHumanSpecificPersonalElectronicsClass getEnumForValue(int value)
    {
       for (LifeFormHumanSpecificPersonalElectronicsClass nextEnum : LifeFormHumanSpecificPersonalElectronicsClass.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum LifeFormHumanSpecificPersonalElectronicsClass");
