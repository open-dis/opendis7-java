 ...
 *  UID 193,
 * marshal size 4;
 * MinefieldSensorTypes has 9 enumerations total.
...
public enum MinefieldSensorTypes 
{
     ...
     */
    public static MinefieldSensorTypes getEnumForValue(int value)
    {
       for (MinefieldSensorTypes nextEnum : MinefieldSensorTypes.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum MinefieldSensorTypes");
