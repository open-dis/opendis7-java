...
public enum EntityAssociationGroupMemberType 
{
    ...
    public static EntityAssociationGroupMemberType unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "EntityAssociationGroupMemberType " + getValue() + " " + name(); 
    }
}
