 ...
 *  UID 321,
 * marshal size 8;
 * EntityAssociationGroupMemberType has 7 enumerations total.
...
public enum EntityAssociationGroupMemberType 
{
     ...
     */
    public static EntityAssociationGroupMemberType getEnumForValue(int value)
    {
       for (EntityAssociationGroupMemberType nextEnum : EntityAssociationGroupMemberType.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum EntityAssociationGroupMemberType");
