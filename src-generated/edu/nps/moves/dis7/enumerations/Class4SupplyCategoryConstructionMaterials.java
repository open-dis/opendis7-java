 ...
 *  UID 604,
 * marshal size 8;
 * Class4SupplyCategoryConstructionMaterials has 3 enumerations total.
...
public enum Class4SupplyCategoryConstructionMaterials implements Category
{
     ...
     */
    public static Class4SupplyCategoryConstructionMaterials getEnumForValue(int value)
    {
       for (Class4SupplyCategoryConstructionMaterials nextEnum : Class4SupplyCategoryConstructionMaterials.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Class4SupplyCategoryConstructionMaterials");
