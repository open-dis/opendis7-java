 ...
 *  UID 298,
 * marshal size 2;
 * NETIDRecordMode has 3 enumerations total.
...
public enum NETIDRecordMode 
{
    ...
    /** B - SATURN COMBAT, SATURN was formerly HAVE QUICK IIA (HQIIA) */
    // autogenerated using string template disenumpart2.txt
     ...
     */
    public static NETIDRecordMode getEnumForValue(int value)
    {
       for (NETIDRecordMode nextEnum : NETIDRecordMode.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum NETIDRecordMode");
