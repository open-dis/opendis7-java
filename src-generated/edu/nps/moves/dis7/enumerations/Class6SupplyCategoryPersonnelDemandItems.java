...
public enum Class6SupplyCategoryPersonnelDemandItems implements Category
{
    ...
    public static Class6SupplyCategoryPersonnelDemandItems unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "Class6SupplyCategoryPersonnelDemandItems " + getValue() + " " + name(); 
    }
}
