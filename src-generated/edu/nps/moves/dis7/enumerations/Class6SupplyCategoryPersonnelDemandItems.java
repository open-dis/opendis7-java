 ...
 *  UID 606,
 * marshal size 8;
 * Class6SupplyCategoryPersonnelDemandItems has 1 enumerations total.
...
public enum Class6SupplyCategoryPersonnelDemandItems implements Category
{
     ...
     */
    public static Class6SupplyCategoryPersonnelDemandItems getEnumForValue(int value)
    {
       for (Class6SupplyCategoryPersonnelDemandItems nextEnum : Class6SupplyCategoryPersonnelDemandItems.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Class6SupplyCategoryPersonnelDemandItems");
