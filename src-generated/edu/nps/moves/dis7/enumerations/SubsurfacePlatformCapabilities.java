...
public class SubsurfacePlatformCapabilities extends DisBitSet implements EntityCapabilities
{
   ...
   */
  public static Bits undef_7 = new Bits(7, 1);
  /**
   ...
   */
  public static Bits undef_8 = new Bits(8, 1);
  ...
  public SubsurfacePlatformCapabilities()
  {
    super(32); // length from bitfield element
  }

  public SubsurfacePlatformCapabilities(Bits wh, int i)
  {
    this();
    set(wh,i);
  }

  public SubsurfacePlatformCapabilities set(Bits wh, int val)
  {
...
/*
  public SubsurfacePlatformCapabilities set(Bits wh, Object val) throws Exception
  {
...
*/
  ...
  public SubsurfacePlatformCapabilities set(int start, int length, int val)
  {
