...
public class SubsurfacePlatformCapabilities extends DisBitSet implements EntityCapabilities
{
  ...
  public SubsurfacePlatformCapabilities(Bits wh, int value)
  {
    this();
    set(wh,value);
  }
   ...
   * @param value bits of interest
   * @return this object */
  public SubsurfacePlatformCapabilities set(Bits wh, int value)
  {
...
*/
   ...
   * @param value bits of interest
   * @return this object */
  public SubsurfacePlatformCapabilities set(int start, int length, int value)
  {
