...
public enum MinefieldSensorTypesOptical 
{
     ...
     */
    public static MinefieldSensorTypesOptical getEnumForValue(int value)
    {
       for (MinefieldSensorTypesOptical nextEnum : MinefieldSensorTypesOptical.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum MinefieldSensorTypesOptical");
