 ...
 *  UID 378,
 * marshal size 1;
 * AppearancePaintScheme has 2 enumerations total.
...
public enum AppearancePaintScheme 
{
     ...
     */
    public static AppearancePaintScheme getEnumForValue(int value)
    {
       for (AppearancePaintScheme nextEnum : AppearancePaintScheme.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum AppearancePaintScheme");
