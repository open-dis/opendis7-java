 ...
 *  UID 417,
 * marshal size 8;
 * DISLiveEntitySubprotocolNumber has 1 enumerations total.
...
public enum DISLiveEntitySubprotocolNumber 
{
     ...
     */
    public static DISLiveEntitySubprotocolNumber getEnumForValue(int value)
    {
       for (DISLiveEntitySubprotocolNumber nextEnum : DISLiveEntitySubprotocolNumber.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum DISLiveEntitySubprotocolNumber");
