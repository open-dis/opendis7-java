...
public enum PlatformSpaceCategory implements Category
{
    ...
    public static PlatformSpaceCategory getEnumForValue(int i)
    {
       for(PlatformSpaceCategory val: PlatformSpaceCategory.values()) {
          if(val.getValue()==i)
              return val;
       }
       System.err.println("No enumeration found for value " + i + " of enumeration PlatformSpaceCategory");
       return null;
    }
   ...
   */
    ...
    {
        return "PlatformSpaceCategory " + getValue() + " " + name(); 
    }
}
