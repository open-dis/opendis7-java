 ...
 *  UID 420,
 * marshal size 1;
 * MinefieldAppearanceLane has 2 enumerations total.
...
public enum MinefieldAppearanceLane 
{
     ...
     */
    public static MinefieldAppearanceLane getEnumForValue(int value)
    {
       for (MinefieldAppearanceLane nextEnum : MinefieldAppearanceLane.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum MinefieldAppearanceLane");
