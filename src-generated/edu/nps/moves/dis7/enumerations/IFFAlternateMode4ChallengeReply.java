 ...
 *  UID 96,
 * marshal size 8;
 * IFFAlternateMode4ChallengeReply has 5 enumerations total.
...
public enum IFFAlternateMode4ChallengeReply 
{
     ...
     */
    public static IFFAlternateMode4ChallengeReply getEnumForValue(int value)
    {
       for (IFFAlternateMode4ChallengeReply nextEnum : IFFAlternateMode4ChallengeReply.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum IFFAlternateMode4ChallengeReply");
