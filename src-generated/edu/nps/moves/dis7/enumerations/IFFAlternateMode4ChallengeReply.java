...
public enum IFFAlternateMode4ChallengeReply 
{
    ...
    public static IFFAlternateMode4ChallengeReply unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "IFFAlternateMode4ChallengeReply " + getValue() + " " + name(); 
    }
}
