...
public class ExpendableCapabilities extends DisBitSet implements EntityCapabilities
{
  ...
  public ExpendableCapabilities(Bits wh, int i)
  {
    this();
    set(wh,i);
  }

  public ExpendableCapabilities set(Bits wh, int val)
  {
...
*/
  ...
  public ExpendableCapabilities set(int start, int length, int val)
  {
