...
public enum MinefieldAppearanceActiveStatus 
{
    ...
    public static MinefieldAppearanceActiveStatus unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "MinefieldAppearanceActiveStatus " + getValue() + " " + name(); 
    }
}
