 ...
 *  UID 419,
 * marshal size 1;
 * MinefieldAppearanceActiveStatus has 2 enumerations total.
...
public enum MinefieldAppearanceActiveStatus 
{
     ...
     */
    public static MinefieldAppearanceActiveStatus getEnumForValue(int value)
    {
       for (MinefieldAppearanceActiveStatus nextEnum : MinefieldAppearanceActiveStatus.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum MinefieldAppearanceActiveStatus");
