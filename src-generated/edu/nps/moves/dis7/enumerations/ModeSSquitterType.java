 ...
 *  UID 354,
 * marshal size 3;
 * ModeSSquitterType has 4 enumerations total.
...
public enum ModeSSquitterType 
{
     ...
     */
    public static ModeSSquitterType getEnumForValue(int value)
    {
       for (ModeSSquitterType nextEnum : ModeSSquitterType.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum ModeSSquitterType");
