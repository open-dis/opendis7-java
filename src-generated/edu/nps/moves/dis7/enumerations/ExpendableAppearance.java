...
public class ExpendableAppearance extends DisBitSet 
{
  ...
  // autogenerated using string template disbitsetcommentxref.txt
  /**
   * (bit position 7, length=2) Describes the status of a flares parachute,  use {@link Parachute} values for this field
   */
  // autogenerated using string template disbitset16.txt
  ...
  // autogenerated using string template disbitsetcommentxref.txt
  /**
   * (bit position 9, length=3) Describes the color of a flares light output or the color of smoke emanating from a smoke expendable,  use {@link FlareSmokeColor} values for this field
   */
  // autogenerated using string template disbitset16.txt
