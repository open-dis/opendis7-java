 ...
 *  UID 347,
 * marshal size 3;
 * ModeSInterrogatorStatusTransmitState has 6 enumerations total.
...
public enum ModeSInterrogatorStatusTransmitState 
{
     ...
     */
    public static ModeSInterrogatorStatusTransmitState getEnumForValue(int value)
    {
       for (ModeSInterrogatorStatusTransmitState nextEnum : ModeSInterrogatorStatusTransmitState.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum ModeSInterrogatorStatusTransmitState");
