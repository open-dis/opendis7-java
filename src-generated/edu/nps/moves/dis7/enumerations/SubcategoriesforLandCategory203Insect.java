 ...
 *  UID 103,
 * marshal size 8;
 * SubcategoriesforLandCategory203Insect has 7 enumerations total.
...
public enum SubcategoriesforLandCategory203Insect implements SubCategory
{
     ...
     */
    public static SubcategoriesforLandCategory203Insect getEnumForValue(int value)
    {
       for (SubcategoriesforLandCategory203Insect nextEnum : SubcategoriesforLandCategory203Insect.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum SubcategoriesforLandCategory203Insect");
