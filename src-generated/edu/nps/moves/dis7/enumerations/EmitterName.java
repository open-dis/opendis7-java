 ...
 *  UID 75,
 * marshal size 16;
 * EmitterName has 2760 enumerations total.
...
public enum EmitterName 
{
    ...
    /** MEADS Multi Function Fire Control Radar (MFCR) */
    // autogenerated using string template disenumpart2.txt
    MEADS_MULTI_FUNCTION_FIRE_CONTROL_RADAR_MFCR (20900, "MEADS Multi Function Fire Control Radar (MFCR)"),
    // autogenerated using string template disenumfootnotecomment.txt

    /** MEADS Surveillance Radar (SR) */
    // autogenerated using string template disenumpart2.txt
    MEADS_SURVEILLANCE_RADAR_SR (20905, "MEADS Surveillance Radar (SR)"),
    // autogenerated using string template disenumfootnotecomment.txt
