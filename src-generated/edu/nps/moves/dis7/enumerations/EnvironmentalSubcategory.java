 ...
 *  UID 21,
 * marshal size 8;
 * EnvironmentalSubcategory has 6 enumerations total.
...
public enum EnvironmentalSubcategory implements SubCategory
{
     ...
     */
    public static EnvironmentalSubcategory getEnumForValue(int value)
    {
       for (EnvironmentalSubcategory nextEnum : EnvironmentalSubcategory.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum EnvironmentalSubcategory");
