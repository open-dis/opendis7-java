 ...
 * PlatformSurfacePassengerVesselSubcategories has 5 enumerations total.
...
public enum PlatformSurfacePassengerVesselSubcategories implements SubCategory
{
     ...
     */
    public static PlatformSurfacePassengerVesselSubcategories getEnumForValue(int value)
    {
       for (PlatformSurfacePassengerVesselSubcategories nextEnum : PlatformSurfacePassengerVesselSubcategories.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum PlatformSurfacePassengerVesselSubcategories");
