...
public enum PlatformSurfacePassengerVesselSubcategories implements SubCategory
{
    ...
    public static PlatformSurfacePassengerVesselSubcategories unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "PlatformSurfacePassengerVesselSubcategories " + getValue() + " " + name(); 
    }
}
