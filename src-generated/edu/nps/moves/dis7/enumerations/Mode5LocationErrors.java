 ...
 *  UID 423,
 * marshal size 1;
 * Mode5LocationErrors has 2 enumerations total.
...
public enum Mode5LocationErrors 
{
     ...
     */
    public static Mode5LocationErrors getEnumForValue(int value)
    {
       for (Mode5LocationErrors nextEnum : Mode5LocationErrors.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Mode5LocationErrors");
