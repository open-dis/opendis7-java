...
public enum LifeFormsSubcategoryGermanWeapons implements SubCategory
{
     ...
     */
    public static LifeFormsSubcategoryGermanWeapons getEnumForValue(int value)
    {
       for (LifeFormsSubcategoryGermanWeapons nextEnum : LifeFormsSubcategoryGermanWeapons.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum LifeFormsSubcategoryGermanWeapons");
