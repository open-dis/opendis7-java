 ...
 *  UID 412,
 * marshal size 1;
 * Mode5LevelSelection has 2 enumerations total.
...
public enum Mode5LevelSelection 
{
     ...
     */
    public static Mode5LevelSelection getEnumForValue(int value)
    {
       for (Mode5LevelSelection nextEnum : Mode5LevelSelection.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Mode5LevelSelection");
