...
public enum AppearanceLifeformHealth 
{
     ...
     */
    public static AppearanceLifeformHealth getEnumForValue(int value)
    {
       for (AppearanceLifeformHealth nextEnum : AppearanceLifeformHealth.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum AppearanceLifeformHealth");
