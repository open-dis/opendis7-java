 ...
 *  UID 309,
 * marshal size 8;
 * ExplosiveMaterialGroups has 7 enumerations total.
...
public enum ExplosiveMaterialGroups 
{
     ...
     */
    public static ExplosiveMaterialGroups getEnumForValue(int value)
    {
       for (ExplosiveMaterialGroups nextEnum : ExplosiveMaterialGroups.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum ExplosiveMaterialGroups");
