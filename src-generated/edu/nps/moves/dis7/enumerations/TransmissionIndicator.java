 ...
 *  UID 372,
 * marshal size 8;
 * TransmissionIndicator has 4 enumerations total.
...
public enum TransmissionIndicator 
{
     ...
     */
    public static TransmissionIndicator getEnumForValue(int value)
    {
       for (TransmissionIndicator nextEnum : TransmissionIndicator.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum TransmissionIndicator");
