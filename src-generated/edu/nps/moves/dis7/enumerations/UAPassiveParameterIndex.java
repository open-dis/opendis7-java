 ...
 *  UID 148,
 * marshal size 16;
 * UAPassiveParameterIndex has 1 enumerations total.
...
public enum UAPassiveParameterIndex 
{
     ...
     */
    public static UAPassiveParameterIndex getEnumForValue(int value)
    {
       for (UAPassiveParameterIndex nextEnum : UAPassiveParameterIndex.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum UAPassiveParameterIndex");
