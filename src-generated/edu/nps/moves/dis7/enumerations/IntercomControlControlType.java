 ...
 *  UID 180,
 * marshal size 8;
 * IntercomControlControlType has 6 enumerations total.
...
public enum IntercomControlControlType 
{
     ...
     */
    public static IntercomControlControlType getEnumForValue(int value)
    {
       for (IntercomControlControlType nextEnum : IntercomControlControlType.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum IntercomControlControlType");
