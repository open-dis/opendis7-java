...
public enum PlatformLandMultipleUnitCargoTruckSubcategories implements SubCategory
{
    ...
    public static PlatformLandMultipleUnitCargoTruckSubcategories unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "PlatformLandMultipleUnitCargoTruckSubcategories " + getValue() + " " + name(); 
    }
}
