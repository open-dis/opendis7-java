 ...
 * PlatformLandMultipleUnitCargoTruckSubcategories has 3 enumerations total.
...
public enum PlatformLandMultipleUnitCargoTruckSubcategories implements SubCategory
{
     ...
     */
    public static PlatformLandMultipleUnitCargoTruckSubcategories getEnumForValue(int value)
    {
       for (PlatformLandMultipleUnitCargoTruckSubcategories nextEnum : PlatformLandMultipleUnitCargoTruckSubcategories.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum PlatformLandMultipleUnitCargoTruckSubcategories");
