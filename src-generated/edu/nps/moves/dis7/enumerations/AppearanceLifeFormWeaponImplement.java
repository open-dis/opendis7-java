 ...
 *  UID 393,
 * marshal size 2;
 * AppearanceLifeFormWeaponImplement has 4 enumerations total.
...
public enum AppearanceLifeFormWeaponImplement 
{
     ...
     */
    public static AppearanceLifeFormWeaponImplement getEnumForValue(int value)
    {
       for (AppearanceLifeFormWeaponImplement nextEnum : AppearanceLifeFormWeaponImplement.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum AppearanceLifeFormWeaponImplement");
