 ...
 *  UID 369,
 * marshal size 8;
 * DataCategory has 3 enumerations total.
...
public enum DataCategory 
{
     ...
     */
    public static DataCategory getEnumForValue(int value)
    {
       for (DataCategory nextEnum : DataCategory.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum DataCategory");
