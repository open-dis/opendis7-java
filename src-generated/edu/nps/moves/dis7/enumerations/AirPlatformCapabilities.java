...
public class AirPlatformCapabilities extends DisBitSet implements EntityCapabilities
{
  ...
  // autogenerated using string template disbitsetcomment.txt
  /**
   * (bit position 4, boolean) Describes whether the entity is equipped with Automatic Dependent Surveillance - Broadcast (ADS-B)
   */
  // autogenerated using string template disbitset15.txt
  ...
  // autogenerated using string template disbitsetcomment.txt
  /**
   * (bit position 5, boolean) The Entity is able to carry a payload in a sling load. The extended appearance record (if available) will identify the current sling load status and entity association and/or entity offset records (if available) will provide additional sling load details (such as payload).
   */
  // autogenerated using string template disbitset15.txt
  ...
  // autogenerated using string template disbitsetcomment.txt
  /**
   * (bit position 9, boolean) Describes whether the entity is equipped with Large Aircraft Infrared Countermeasures (LAIRCM)
   */
  // autogenerated using string template disbitset15.txt
