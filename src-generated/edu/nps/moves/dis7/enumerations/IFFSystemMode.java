 ...
 *  UID 84,
 * marshal size 8;
 * IFFSystemMode has 6 enumerations total.
...
public enum IFFSystemMode 
{
     ...
     */
    public static IFFSystemMode getEnumForValue(int value)
    {
       for (IFFSystemMode nextEnum : IFFSystemMode.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum IFFSystemMode");
