 ...
 *  UID 299,
 * marshal size 2;
 * NETIDRecordFrequencyTable has 4 enumerations total.
...
public enum NETIDRecordFrequencyTable 
{
    ...
    /** HQII - NATO/Europe Area Operations */
    // autogenerated using string template disenumpart2.txt
    HQII_NATO_EUROPE_AREA_OPERATIONS (1, "HQII - NATO/Europe Area Operations"),
    // autogenerated using string template disenumfootnotecomment.txt

    /** HQII - Non-NATO/Europe Area Operations */
    // autogenerated using string template disenumpart2.txt
    HQII_NON_NATO_EUROPE_AREA_OPERATIONS (2, "HQII - Non-NATO/Europe Area Operations"),
    // autogenerated using string template disenumfootnotecomment.txt

    /** SATURN Operations, SATURN was formerly HAVE QUICK IIA (HQIIA) */
    // autogenerated using string template disenumpart2.txt
     ...
     */
    public static NETIDRecordFrequencyTable getEnumForValue(int value)
    {
       for (NETIDRecordFrequencyTable nextEnum : NETIDRecordFrequencyTable.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum NETIDRecordFrequencyTable");
