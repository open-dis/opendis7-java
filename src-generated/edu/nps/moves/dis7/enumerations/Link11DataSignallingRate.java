 ...
 *  UID 732,
 * marshal size 8;
 * Link11DataSignallingRate has 5 enumerations total.
...
public enum Link11DataSignallingRate 
{
     ...
     */
    public static Link11DataSignallingRate getEnumForValue(int value)
    {
       for (Link11DataSignallingRate nextEnum : Link11DataSignallingRate.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Link11DataSignallingRate");
