 ...
 *  UID 288,
 * marshal size 16;
 * IOActionIOActionPhase has 7 enumerations total.
...
public enum IOActionIOActionPhase 
{
     ...
     */
    public static IOActionIOActionPhase getEnumForValue(int value)
    {
       for (IOActionIOActionPhase nextEnum : IOActionIOActionPhase.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum IOActionIOActionPhase");
