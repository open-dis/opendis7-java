 ...
 *  UID 479,
 * marshal size 8;
 * LifeFormSubsurfaceCategories has 5 enumerations total.
...
public enum LifeFormSubsurfaceCategories 
{
     ...
     */
    public static LifeFormSubsurfaceCategories getEnumForValue(int value)
    {
       for (LifeFormSubsurfaceCategories nextEnum : LifeFormSubsurfaceCategories.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum LifeFormSubsurfaceCategories");
