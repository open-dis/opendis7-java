 ...
 *  UID 424,
 * marshal size 2;
 * MinefieldPaintSchemeAlgae has 4 enumerations total.
...
public enum MinefieldPaintSchemeAlgae 
{
     ...
     */
    public static MinefieldPaintSchemeAlgae getEnumForValue(int value)
    {
       for (MinefieldPaintSchemeAlgae nextEnum : MinefieldPaintSchemeAlgae.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum MinefieldPaintSchemeAlgae");
