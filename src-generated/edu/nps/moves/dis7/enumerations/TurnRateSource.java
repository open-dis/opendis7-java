 ...
 *  UID 366,
 * marshal size 2;
 * TurnRateSource has 3 enumerations total.
...
public enum TurnRateSource 
{
     ...
     */
    public static TurnRateSource getEnumForValue(int value)
    {
       for (TurnRateSource nextEnum : TurnRateSource.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum TurnRateSource");
