 ...
 *  UID 290,
 * marshal size 8;
 * IOEffectsRecordIOStatus has 8 enumerations total.
...
public enum IOEffectsRecordIOStatus 
{
     ...
     */
    public static IOEffectsRecordIOStatus getEnumForValue(int value)
    {
       for (IOEffectsRecordIOStatus nextEnum : IOEffectsRecordIOStatus.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum IOEffectsRecordIOStatus");
