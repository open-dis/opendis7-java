...
public enum DISPDUStatusLVCIndicatorLVC 
{
     ...
     */
    public static DISPDUStatusLVCIndicatorLVC getEnumForValue(int value)
    {
       for (DISPDUStatusLVCIndicatorLVC nextEnum : DISPDUStatusLVCIndicatorLVC.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum DISPDUStatusLVCIndicatorLVC");
