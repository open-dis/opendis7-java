 ...
 *  UID 26,
 * marshal size 8;
 * ExpendableSurfaceCategory has 7 enumerations total.
...
public enum ExpendableSurfaceCategory implements Category
{
     ...
     */
    public static ExpendableSurfaceCategory getEnumForValue(int value)
    {
       for (ExpendableSurfaceCategory nextEnum : ExpendableSurfaceCategory.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum ExpendableSurfaceCategory");
