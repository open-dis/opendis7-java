 ...
 *  UID 185,
 * marshal size 16;
 * IntercomControlRecordType has 3 enumerations total.
...
public enum IntercomControlRecordType 
{
     ...
     */
    public static IntercomControlRecordType getEnumForValue(int value)
    {
       for (IntercomControlRecordType nextEnum : IntercomControlRecordType.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum IntercomControlRecordType");
