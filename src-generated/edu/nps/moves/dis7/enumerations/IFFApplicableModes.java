 ...
 *  UID 339,
 * marshal size 8;
 * IFFApplicableModes has 2 enumerations total.
...
public enum IFFApplicableModes 
{
     ...
     */
    public static IFFApplicableModes getEnumForValue(int value)
    {
       for (IFFApplicableModes nextEnum : IFFApplicableModes.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum IFFApplicableModes");
