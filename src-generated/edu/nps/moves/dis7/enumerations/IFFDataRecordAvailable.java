 ...
 *  UID 360,
 * marshal size 1;
 * IFFDataRecordAvailable has 2 enumerations total.
...
public enum IFFDataRecordAvailable 
{
     ...
     */
    public static IFFDataRecordAvailable getEnumForValue(int value)
    {
       for (IFFDataRecordAvailable nextEnum : IFFDataRecordAvailable.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum IFFDataRecordAvailable");
