...
public class CulturalFeatureAppearance extends DisBitSet 
{
   ...
   */
  public static Bits undef_3 = new Bits(15, 1);
  /**
   * Describes whether the entity is frozen and should not be dead reckoned
   */
  public static Bits undef_4 = new Bits(21, 1);
  /**
   * Describes whether the internal heat is on or off
   */
  public static Bits undef_5 = new Bits(22, 1);
  /**
   ...
   */
  public static Bits undef_7 = new Bits(28, 1);
  /**
   * Describes whether the interior lights are on or off
   */
  public static Bits undef_8 = new Bits(29, 1);
  /**
   * Describes whether or not the entity is masked or cloaked
   */
  public static Bits undef_9 = new Bits(31, 1);
