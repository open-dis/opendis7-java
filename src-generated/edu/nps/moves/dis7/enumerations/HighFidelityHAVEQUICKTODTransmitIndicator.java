 ...
 *  UID 297,
 * marshal size 8;
 * HighFidelityHAVEQUICKTODTransmitIndicator has 2 enumerations total.
...
public enum HighFidelityHAVEQUICKTODTransmitIndicator 
{
     ...
     */
    public static HighFidelityHAVEQUICKTODTransmitIndicator getEnumForValue(int value)
    {
       for (HighFidelityHAVEQUICKTODTransmitIndicator nextEnum : HighFidelityHAVEQUICKTODTransmitIndicator.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum HighFidelityHAVEQUICKTODTransmitIndicator");
