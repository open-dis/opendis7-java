...
public enum HighFidelityHAVEQUICKTODTransmitIndicator 
{
    ...
    public static HighFidelityHAVEQUICKTODTransmitIndicator unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "HighFidelityHAVEQUICKTODTransmitIndicator " + getValue() + " " + name(); 
    }
}
