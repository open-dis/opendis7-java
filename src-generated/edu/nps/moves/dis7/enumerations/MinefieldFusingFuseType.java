 ...
 *  UID 422,
 * marshal size 7;
 * MinefieldFusingFuseType has 7 enumerations total.
...
public enum MinefieldFusingFuseType 
{
     ...
     */
    public static MinefieldFusingFuseType getEnumForValue(int value)
    {
       for (MinefieldFusingFuseType nextEnum : MinefieldFusingFuseType.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum MinefieldFusingFuseType");
