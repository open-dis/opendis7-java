 ...
 *  UID 334,
 * marshal size 16;
 * RecordQueryREventType has 2 enumerations total.
...
public enum RecordQueryREventType 
{
     ...
     */
    public static RecordQueryREventType getEnumForValue(int value)
    {
       for (RecordQueryREventType nextEnum : RecordQueryREventType.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum RecordQueryREventType");
