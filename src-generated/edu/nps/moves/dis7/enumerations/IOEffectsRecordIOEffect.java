 ...
 *  UID 292,
 * marshal size 8;
 * IOEffectsRecordIOEffect has 5 enumerations total.
...
public enum IOEffectsRecordIOEffect 
{
     ...
     */
    public static IOEffectsRecordIOEffect getEnumForValue(int value)
    {
       for (IOEffectsRecordIOEffect nextEnum : IOEffectsRecordIOEffect.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum IOEffectsRecordIOEffect");
