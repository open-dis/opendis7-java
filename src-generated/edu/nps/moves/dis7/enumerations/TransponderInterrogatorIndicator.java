 ...
 *  UID 337,
 * marshal size 1;
 * TransponderInterrogatorIndicator has 2 enumerations total.
...
public enum TransponderInterrogatorIndicator 
{
     ...
     */
    public static TransponderInterrogatorIndicator getEnumForValue(int value)
    {
       for (TransponderInterrogatorIndicator nextEnum : TransponderInterrogatorIndicator.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum TransponderInterrogatorIndicator");
