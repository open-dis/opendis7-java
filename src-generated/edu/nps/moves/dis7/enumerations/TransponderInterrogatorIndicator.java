...
public enum TransponderInterrogatorIndicator 
{
    ...
    public static TransponderInterrogatorIndicator unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "TransponderInterrogatorIndicator " + getValue() + " " + name(); 
    }
}
