 ...
 *  UID 164,
 * marshal size 8;
 * TransmitterTransmitState has 3 enumerations total.
...
public enum TransmitterTransmitState 
{
     ...
     */
    public static TransmitterTransmitState getEnumForValue(int value)
    {
       for (TransmitterTransmitState nextEnum : TransmitterTransmitState.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum TransmitterTransmitState");
