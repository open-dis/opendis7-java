...
public enum IntercomControlCommunicationsClass 
{
    ...
    public static IntercomControlCommunicationsClass unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "IntercomControlCommunicationsClass " + getValue() + " " + name(); 
    }
}
