 ...
 *  UID 416,
 * marshal size 1;
 * IntercomControlCommunicationsClass has 2 enumerations total.
...
public enum IntercomControlCommunicationsClass 
{
     ...
     */
    public static IntercomControlCommunicationsClass getEnumForValue(int value)
    {
       for (IntercomControlCommunicationsClass nextEnum : IntercomControlCommunicationsClass.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum IntercomControlCommunicationsClass");
