 ...
 *  UID 213,
 * marshal size 8;
 * IsGroupOfGroupedEntityCategory has 10 enumerations total.
...
public enum IsGroupOfGroupedEntityCategory implements Category
{
     ...
     */
    public static IsGroupOfGroupedEntityCategory getEnumForValue(int value)
    {
       for (IsGroupOfGroupedEntityCategory nextEnum : IsGroupOfGroupedEntityCategory.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum IsGroupOfGroupedEntityCategory");
