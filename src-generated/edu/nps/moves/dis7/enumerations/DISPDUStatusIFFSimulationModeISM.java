...
public enum DISPDUStatusIFFSimulationModeISM 
{
    ...
    public static DISPDUStatusIFFSimulationModeISM unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "DISPDUStatusIFFSimulationModeISM " + getValue() + " " + name(); 
    }
}
