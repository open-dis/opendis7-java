...
public enum DISPDUStatusIFFSimulationModeISM 
{
     ...
     */
    public static DISPDUStatusIFFSimulationModeISM getEnumForValue(int value)
    {
       for (DISPDUStatusIFFSimulationModeISM nextEnum : DISPDUStatusIFFSimulationModeISM.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum DISPDUStatusIFFSimulationModeISM");
