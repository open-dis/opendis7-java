 ...
 *  UID 468,
 * marshal size 8;
 * Link11TerminalMode has 3 enumerations total.
...
public enum Link1111BTerminalMode 
{
     ...
     */
    public static Link1111BTerminalMode getEnumForValue(int value)
    {
       for (Link1111BTerminalMode nextEnum : Link1111BTerminalMode.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Link1111BTerminalMode");
