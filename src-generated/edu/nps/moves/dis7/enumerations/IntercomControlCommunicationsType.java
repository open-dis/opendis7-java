...
public enum IntercomControlCommunicationsType 
{
    ...
    public static IntercomControlCommunicationsType unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "IntercomControlCommunicationsType " + getValue() + " " + name(); 
    }
}
