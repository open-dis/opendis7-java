 ...
 *  UID 181,
 * marshal size 7;
 * IntercomControlCommunicationsType has 5 enumerations total.
...
public enum IntercomControlCommunicationsType 
{
     ...
     */
    public static IntercomControlCommunicationsType getEnumForValue(int value)
    {
       for (IntercomControlCommunicationsType nextEnum : IntercomControlCommunicationsType.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum IntercomControlCommunicationsType");
