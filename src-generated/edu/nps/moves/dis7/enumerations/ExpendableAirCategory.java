 ...
 *  UID 25,
 * marshal size 8;
 * ExpendableAirCategory has 12 enumerations total.
...
public enum ExpendableAirCategory implements Category
{
     ...
     */
    public static ExpendableAirCategory getEnumForValue(int value)
    {
       for (ExpendableAirCategory nextEnum : ExpendableAirCategory.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum ExpendableAirCategory");
