 ...
 *  UID 211,
 * marshal size 16;
 * IsPartOfPosition has 3 enumerations total.
...
public enum IsPartOfPosition 
{
     ...
     */
    public static IsPartOfPosition getEnumForValue(int value)
    {
       for (IsPartOfPosition nextEnum : IsPartOfPosition.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum IsPartOfPosition");
