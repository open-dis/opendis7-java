 ...
 *  UID 97,
 * marshal size 8;
 * IFFSystemType1OperationalParameter1 has 1 enumerations total.
...
public enum IFFSystemType1OperationalParameter1 
{
     ...
     */
    public static IFFSystemType1OperationalParameter1 getEnumForValue(int value)
    {
       for (IFFSystemType1OperationalParameter1 nextEnum : IFFSystemType1OperationalParameter1.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum IFFSystemType1OperationalParameter1");
