 ...
 *  UID 470,
 * marshal size 16;
 * Link11ModeofOperation has 6 enumerations total.
...
public enum Link1111BModeofOperation 
{
     ...
     */
    public static Link1111BModeofOperation getEnumForValue(int value)
    {
       for (Link1111BModeofOperation nextEnum : Link1111BModeofOperation.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Link1111BModeofOperation");
