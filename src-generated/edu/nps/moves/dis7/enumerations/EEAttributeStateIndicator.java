 ...
 *  UID 300,
 * marshal size 8;
 * EEAttributeStateIndicator has 3 enumerations total.
...
public enum EEAttributeStateIndicator 
{
     ...
     */
    public static EEAttributeStateIndicator getEnumForValue(int value)
    {
       for (EEAttributeStateIndicator nextEnum : EEAttributeStateIndicator.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum EEAttributeStateIndicator");
