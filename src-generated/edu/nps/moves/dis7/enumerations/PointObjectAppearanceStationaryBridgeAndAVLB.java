...
;
  ...
  public PointObjectAppearanceStationaryBridgeAndAVLB(Bits wh, int i)
  {
    this();
    set(wh,i);
  }

  public PointObjectAppearanceStationaryBridgeAndAVLB set(Bits wh, int val)
  {
...
*/
  ...
  public PointObjectAppearanceStationaryBridgeAndAVLB set(int start, int length, int val)
  {
