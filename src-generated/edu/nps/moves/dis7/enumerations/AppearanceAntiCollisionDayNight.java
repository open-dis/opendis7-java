 ...
 *  UID 397,
 * marshal size 1;
 * AppearanceAntiCollisionDayNight has 2 enumerations total.
...
public enum AppearanceAntiCollisionDayNight 
{
     ...
     */
    public static AppearanceAntiCollisionDayNight getEnumForValue(int value)
    {
       for (AppearanceAntiCollisionDayNight nextEnum : AppearanceAntiCollisionDayNight.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum AppearanceAntiCollisionDayNight");
