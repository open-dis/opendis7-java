 ...
 * PlatformLandTrainsSubcategories has 8 enumerations total.
...
public enum PlatformLandTrainsSubcategories implements SubCategory
{
     ...
     */
    public static PlatformLandTrainsSubcategories getEnumForValue(int value)
    {
       for (PlatformLandTrainsSubcategories nextEnum : PlatformLandTrainsSubcategories.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum PlatformLandTrainsSubcategories");
