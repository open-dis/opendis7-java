 ...
 *  UID 385,
 * marshal size 1;
 * AppearanceConcealedPosition has 2 enumerations total.
...
public enum AppearanceConcealedPosition 
{
     ...
     */
    public static AppearanceConcealedPosition getEnumForValue(int value)
    {
       for (AppearanceConcealedPosition nextEnum : AppearanceConcealedPosition.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum AppearanceConcealedPosition");
