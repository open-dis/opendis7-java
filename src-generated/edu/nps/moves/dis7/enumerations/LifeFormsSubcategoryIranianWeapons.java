...
public enum LifeFormsSubcategoryIranianWeapons implements SubCategory
{
    ...
    public static LifeFormsSubcategoryIranianWeapons unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "LifeFormsSubcategoryIranianWeapons " + getValue() + " " + name(); 
    }
}
