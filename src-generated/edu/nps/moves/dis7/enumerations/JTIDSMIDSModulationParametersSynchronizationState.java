...
public enum JTIDSMIDSModulationParametersSynchronizationState 
{
    ...
    public static JTIDSMIDSModulationParametersSynchronizationState unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "JTIDSMIDSModulationParametersSynchronizationState " + getValue() + " " + name(); 
    }
}
