 ...
 *  UID 175,
 * marshal size 8;
 * JTIDSMIDSModulationParametersSynchronizationState has 5 enumerations total.
...
public enum JTIDSMIDSModulationParametersSynchronizationState 
{
     ...
     */
    public static JTIDSMIDSModulationParametersSynchronizationState getEnumForValue(int value)
    {
       for (JTIDSMIDSModulationParametersSynchronizationState nextEnum : JTIDSMIDSModulationParametersSynchronizationState.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum JTIDSMIDSModulationParametersSynchronizationState");
