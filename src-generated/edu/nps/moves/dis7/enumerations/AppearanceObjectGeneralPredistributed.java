 ...
 *  UID 406,
 * marshal size 1;
 * AppearanceObjectGeneralPredistributed has 2 enumerations total.
...
public enum AppearanceObjectGeneralPredistributed 
{
     ...
     */
    public static AppearanceObjectGeneralPredistributed getEnumForValue(int value)
    {
       for (AppearanceObjectGeneralPredistributed nextEnum : AppearanceObjectGeneralPredistributed.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum AppearanceObjectGeneralPredistributed");
