 ...
 *  UID 466,
 * marshal size 4;
 * Material has 4 enumerations total.
...
public enum Material 
{
     ...
     */
    public static Material getEnumForValue(int value)
    {
       for (Material nextEnum : Material.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Material");
