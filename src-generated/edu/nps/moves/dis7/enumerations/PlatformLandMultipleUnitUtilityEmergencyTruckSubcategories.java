...
public enum PlatformLandMultipleUnitUtilityEmergencyTruckSubcategories implements SubCategory
{
    ...
    public static PlatformLandMultipleUnitUtilityEmergencyTruckSubcategories unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "PlatformLandMultipleUnitUtilityEmergencyTruckSubcategories " + getValue() + " " + name(); 
    }
}
