 ...
 * PlatformLandMultipleUnitUtilityEmergencyTruckSubcategories has 2 enumerations total.
...
public enum PlatformLandMultipleUnitUtilityEmergencyTruckSubcategories implements SubCategory
{
     ...
     */
    public static PlatformLandMultipleUnitUtilityEmergencyTruckSubcategories getEnumForValue(int value)
    {
       for (PlatformLandMultipleUnitUtilityEmergencyTruckSubcategories nextEnum : PlatformLandMultipleUnitUtilityEmergencyTruckSubcategories.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum PlatformLandMultipleUnitUtilityEmergencyTruckSubcategories");
