...
public enum DISPDUStatusRadioAttachedIndicatorRAI 
{
    ...
    public static DISPDUStatusRadioAttachedIndicatorRAI unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "DISPDUStatusRadioAttachedIndicatorRAI " + getValue() + " " + name(); 
    }
}
