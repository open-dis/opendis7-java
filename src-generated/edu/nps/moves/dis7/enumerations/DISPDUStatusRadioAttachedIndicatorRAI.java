...
public enum DISPDUStatusRadioAttachedIndicatorRAI 
{
     ...
     */
    public static DISPDUStatusRadioAttachedIndicatorRAI getEnumForValue(int value)
    {
       for (DISPDUStatusRadioAttachedIndicatorRAI nextEnum : DISPDUStatusRadioAttachedIndicatorRAI.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum DISPDUStatusRadioAttachedIndicatorRAI");
