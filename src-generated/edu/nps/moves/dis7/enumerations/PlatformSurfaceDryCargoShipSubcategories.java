 ...
 * PlatformSurfaceDryCargoShipSubcategories has 7 enumerations total.
...
public enum PlatformSurfaceDryCargoShipSubcategories implements SubCategory
{
     ...
     */
    public static PlatformSurfaceDryCargoShipSubcategories getEnumForValue(int value)
    {
       for (PlatformSurfaceDryCargoShipSubcategories nextEnum : PlatformSurfaceDryCargoShipSubcategories.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum PlatformSurfaceDryCargoShipSubcategories");
