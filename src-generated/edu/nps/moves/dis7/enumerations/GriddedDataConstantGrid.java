 ...
 *  UID 245,
 * marshal size 8;
 * GriddedDataConstantGrid has 2 enumerations total.
...
public enum GriddedDataConstantGrid 
{
     ...
     */
    public static GriddedDataConstantGrid getEnumForValue(int value)
    {
       for (GriddedDataConstantGrid nextEnum : GriddedDataConstantGrid.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum GriddedDataConstantGrid");
