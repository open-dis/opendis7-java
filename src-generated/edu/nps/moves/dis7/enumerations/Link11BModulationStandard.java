 ...
 *  UID 741,
 * marshal size 8;
 * Link11BModulationStandard has 2 enumerations total.
...
public enum Link11BModulationStandard 
{
     ...
     */
    public static Link11BModulationStandard getEnumForValue(int value)
    {
       for (Link11BModulationStandard nextEnum : Link11BModulationStandard.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum Link11BModulationStandard");
