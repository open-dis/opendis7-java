 ...
 *  UID 414,
 * marshal size 8;
 * SensorTypeSource has 6 enumerations total.
...
public enum SensorTypeSource 
{
     ...
     */
    public static SensorTypeSource getEnumForValue(int value)
    {
       for (SensorTypeSource nextEnum : SensorTypeSource.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum SensorTypeSource");
