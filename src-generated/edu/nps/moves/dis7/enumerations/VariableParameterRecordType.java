 ...
 *  UID 56,
 * marshal size 8;
 * VariableParameterRecordType has 8 enumerations total.
...
public enum VariableParameterRecordType 
{
    ...
    /** Max Fuel Flow Rate */
    // autogenerated using string template disenumpart2.txt
    MAX_FUEL_FLOW_RATE (36, "Max Fuel Flow Rate"),
    // autogenerated using string template disenumfootnotecomment.txt

    /** Virtual Boom Information */
    // autogenerated using string template disenumpart2.txt
    VIRTUAL_BOOM_INFORMATION (37, "Virtual Boom Information"),
    // autogenerated using string template disenumfootnotecomment.txt

    /** Aerial Refueling Latch State */
    // autogenerated using string template disenumpart2.txt
    AERIAL_REFUELING_LATCH_STATE (38, "Aerial Refueling Latch State");
