...
public enum IntercomControlTransmitLineState 
{
    ...
    public static IntercomControlTransmitLineState unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "IntercomControlTransmitLineState " + getValue() + " " + name(); 
    }
}
