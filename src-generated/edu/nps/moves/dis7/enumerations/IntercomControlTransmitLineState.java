...
public enum IntercomControlTransmitLineState 
{
     ...
     */
    public static IntercomControlTransmitLineState getEnumForValue(int value)
    {
       for (IntercomControlTransmitLineState nextEnum : IntercomControlTransmitLineState.values())
       {
          if (nextEnum.getValue() == value)
              return nextEnum;
       }
       System.out.flush(); // ensure contiguous console outputs
       System.err.println("No corresponding enumeration found for value " + value + " of enum IntercomControlTransmitLineState");
