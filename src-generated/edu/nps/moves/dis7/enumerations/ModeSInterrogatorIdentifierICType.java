...
public enum ModeSInterrogatorIdentifierICType 
{
    ...
    public static ModeSInterrogatorIdentifierICType unmarshalEnum(ByteBuffer byteBuffer) throws Exception
    {
        /*
        try {
   ...
   */
    ...
    {
        return "ModeSInterrogatorIdentifierICType " + getValue() + " " + name(); 
    }
}
