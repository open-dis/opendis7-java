...
;
  ...
  public LinearObjectAppearanceBreach(Bits wh, int i)
  {
    this();
    set(wh,i);
  }

  public LinearObjectAppearanceBreach set(Bits wh, int val)
  {
...
*/
  ...
  public LinearObjectAppearanceBreach set(int start, int length, int val)
  {
