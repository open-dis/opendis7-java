...
Now available: [latest release](https://github.com/open-dis/opendis7-java/releases) autogenerated using GitHub Actions for Continuous Integration / Continuous Development (CI/CD).
